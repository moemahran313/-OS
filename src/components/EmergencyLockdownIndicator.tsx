...
export default function EmergencyLockdownIndicator({
  navigateToPayroll,
}: {
  ...
  useEffect(() => {
    const checkLockdown = () => {
      ...
      const cycleTotal = Math.ceil(
        (nextLockoutDate.getTime() - prevLockout.getTime()) / (1000 * 60 * 60 * 24)
      );
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs font-bold text-rose-700 mt-1">
                تم تفعيل الإقفال الآلي لمسيرات الرواتب. يرجى المراجعة الفورية.
              </p>
            </div>
          </div>
          <button
