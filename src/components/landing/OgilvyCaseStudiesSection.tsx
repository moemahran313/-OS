  ...
  const caseStudies = [
    {
      ...
      quote:
        "كنا نستخدم زوهو للحسابات، وسيستم آخر للرواتب، وجداول أكسيل معقدة للمواقع. في نهاية كل شهر كان المحاسب يستغرق أسبوعين للتحقق من الفواتير والرواتب. بعد الانتقال لـ مدارج، أصبحت ملفات SIF تصدر بتوافُق 100% مع البنك، والفواتير مرتبطة مباشرة بهيئة الزكاة بدون خطأ واحد.",
