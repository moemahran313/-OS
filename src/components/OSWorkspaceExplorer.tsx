...
const WORKSPACE_DATA: WorkspaceGroup[] = [
  ...
  },
  {
    ...
    tools: [
      {
        id: "MarketingCopilot",
        nameAr: "مساعد التسويق والعملاء",
        nameEn: "Marketing Copilot & Growth",
        descriptionAr: "جناح موحد لإدارة وتحليل كافة حملات التسويق، الإعلانات، والبريد الإلكتروني بذكاء",
        descriptionEn: "All-in-one AI console for campaign planning, email automation, and social monitoring",
        path: "/app/marketing-copilot",
        icon: Sparkles,
        badgeAr: "موحد",
        badgeEn: "Consolidated",
      },
    ],
  },
  {
