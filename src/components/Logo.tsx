...
export function Logo({
      ...
      >
        <svg viewBox="0 0 24 24" className="w-full h-full drop-shadow-sm overflow-visible">
          ...
          <rect
            ...
            rx="3.5"
            fill="currentColor"
            className="opacity-20 origin-bottom transition-all duration-500 ease-out group-hover:-translate-y-1 group-hover:scale-y-[1.05]"
          />
          ...
          <rect
            ...
            className="origin-bottom transition-all duration-500 ease-out group-hover:translate-y-0.5 group-hover:scale-y-[0.98]"
          />
          ...
          <rect
            ...
            width="20"
            height="1.5"
            fill={theme === "dark" ? "rgba(0,0,0,0.2)" : "rgba(255,255,255,0.4)"}
            className="transition-all duration-500 ease-out group-hover:translate-y-0.5"
          />
        </svg>
      </div>
  ...
  const wrapperClass = cn(
    "flex items-center gap-3 group cursor-pointer outline-none select-none",
    className
  );
