  ...
  const [transactions] = useState<TaxTransaction[]>([
    {
      ...
      refNo: "INV-2026-001",
      date: "2026-05-10",
      partyName: "مجموعة الشايع التجارية",
      baseAmount: 145000,
      vatAmount: 21750,
      vatRate: 15,
    },
    {
      ...
      refNo: "BILL-2026-081",
      date: "2026-05-01",
      partyName: "مؤسسة التوريدات اللوجستية",
      baseAmount: 40000,
      vatAmount: 6000,
      vatRate: 15,
    },
    {
      ...
      refNo: "INV-2026-002",
      date: "2026-05-15",
      partyName: "شركة المراعي المحدودة",
      baseAmount: 89000,
      vatAmount: 13350,
      vatRate: 15,
    },
    {
      ...
      refNo: "BILL-2026-082",
      date: "2026-04-10",
      partyName: "شركة الخرسانة المتكاملة",
      baseAmount: 90000,
      vatAmount: 13500,
      vatRate: 15,
    },
      ...
      <div className="flex justify-between items-center bg-zinc-50 dark:bg-zinc-100 p-4 rounded-2xl border border-zinc-150 dark:border-zinc-850">
        <div>
          ...
          <p className="text-[10px] text-zinc-400 font-bold">
            إقرارات ضريبة القيمة المضافة المتوافقة بالكامل مع متطلبات هيئة الزكاة والضريبة والجمارك
            بالمملكة
          </p>
        </div>
        <button
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
          ...
          >
            <div>
              ...
              <p className="text-[10px] text-zinc-400 font-bold">
                النموذج الرسمي متوافق مع لوائح الفوترة الضريبية وإجراءات التقديم الإلكتروني
              </p>
            </div>
            ...
            <div className="border border-zinc-100 dark:border-zinc-850 rounded-2xl overflow-hidden text-xs">
              ...
              <div className="grid grid-cols-3 p-3 border-b border-zinc-50 dark:border-zinc-850 font-bold">
                ...
                <span className="text-left font-mono text-emerald-600">
                  +{totalSalesVat.toLocaleString()} ر.س
                </span>
              </div>
              ...
              <div className="grid grid-cols-3 p-3 border-b border-zinc-50 dark:border-zinc-850 font-bold">
                ...
                <span className="text-left font-mono">
                  {totalPurchasesBase.toLocaleString()} ر.س
                </span>
                <span className="text-left font-mono text-rose-500">
                  -{totalPurchasesVat.toLocaleString()} ر.س
                </span>
              </div>
            ...
            <div className="bg-indigo-50 dark:bg-indigo-950/20 p-4 rounded-xl border border-indigo-100 dark:border-indigo-900/30 flex items-start gap-2.5 text-xs text-indigo-850 dark:text-indigo-400">
              ...
              <div>
                ...
                <span>
                  هذه المسودة تغطي الفترة الضريبية الجارية، ويتوجب ترحيل كافة فواتير المبيعات
                  والمشتريات لليومية العامة بشكل تام قبل تقديم الإقرار عبر بوابة الهيئة.
                </span>
              </div>
            </div>
