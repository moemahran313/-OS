...
export default function Resources() {
  ...
  const [vatResult, setVatResult] = useState<{ total: number; vat: number; beforeVat: number }>({
    total: 1150,
    vat: 150,
    beforeVat: 1000,
  });
  ...
  const [wpsResult, setWpsResult] = useState<{ percentage: number; status: string; color: string }>(
    { percentage: 90, status: "نطاق آمن (أخضر مرتفع)", color: "text-emerald-400" }
  );
  ...
  useEffect(() => {
    ...
    if (metaDesc) {
      metaDesc.setAttribute(
        "content",
        "دليلك الشامل للمتطلبات التنظيمية والفوترة الإلكترونية لـ هيئة الزكاة والجمارك (ZATCA)، حماية الأجور (WPS)، وإدارة المبيعات وسلاسل الإمداد في الخليج."
      );
    }
  }, []);
  ...
  return (
    ...
    >
      ...
      <main className="pt-36 pb-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 max-w-7xl relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            >
              تصفح المقالات التقنية والقانونية الشاملة والآلات الحاسبة التفاعلية لامتثال متطلبات
              الزكاة والدخل وحماية الأجور WPS وإدارة صفقاتك بكفاءة.
            </motion.p>
          </div>
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-zinc-400">
                    حساب قيمة الضريبة والمجموع الإجمالي أو العكس
                  </p>
                </div>
              </div>
              ...
              <div className="bg-zinc-950/80 rounded-2xl p-6 border border-white/5 grid grid-cols-3 gap-4 text-center font-mono">
                <div>
                  ...
                  <span className="text-sm font-black text-white">
                    {vatResult.beforeVat.toLocaleString()} ريال
                  </span>
                </div>
                <div>
                  <span className="block text-[10px] font-bold text-zinc-500 mb-1">
                  ...
                  <span className="text-sm font-black text-primary">
                    +{vatResult.vat.toLocaleString()} ريال
                  </span>
                </div>
                <div>
                  <span className="block text-[10px] font-bold text-zinc-500 mb-1">
                  ...
                  <span className="text-base font-black text-emerald-400">
                    {vatResult.total.toLocaleString()} ريال
                  </span>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-zinc-400">
                    تأكد من نطاق منشأتك لتجنب العقوبات وإيقاف الخدمات
                  </p>
                </div>
              </div>
              ...
              <div className="bg-zinc-950/80 rounded-2xl p-6 border border-white/5 flex items-center justify-between font-sans">
                <div className="space-y-1">
                  ...
                  <span className={`text-sm font-black ${wpsResult.color}`}>
                    {wpsResult.status}
                  </span>
                </div>
                <div className="text-left shrink-0">
                  <span className="block text-xs font-bold text-zinc-500 mb-1">النسبة</span>
                  <span className={`text-2xl font-black font-mono ${wpsResult.color}`}>
                    {wpsResult.percentage}%
                  </span>
                </div>
              </div>
            </motion.div>
              ...
              >
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  ...
                  {selectedArticle.tags.map((tag) => (
                    <span
                      key={tag}
                      className="px-3 py-1 bg-white/5 border border-white/5 rounded-full text-[10px] font-bold text-zinc-400"
                    >
                      #{tag}
                    </span>
                  ))}
                ...
                <div className="border-t border-white/5 mt-12 pt-8 flex flex-col sm:flex-row justify-between items-center gap-6">
                  <div className="text-right">
                    <h4 className="text-white font-black text-base mb-1">
                      هل تريد تطبيق هذا الامتثال في شركتك؟
                    </h4>
                    <p className="text-xs text-zinc-400">
                      يقدم نظام مدارج OS حلولاً مؤتمتة متوافقة بالكامل مع القوانين والتشريعات.
                    </p>
                  </div>
                  <div className="flex gap-4">
                    <Link
                      to="/demo"
                      className="px-5 py-3 bg-white/5 border border-white/10 hover:bg-white/10 text-white rounded-xl text-xs font-black transition-colors"
                    >
                      تجربة النظام الحية
                    </Link>
                    <Link
                      to="/app"
                      className="px-5 py-3 bg-primary text-white rounded-xl text-xs font-black hover:bg-primary/95 shadow-md shadow-primary/25 transition-all"
                    >
                      ابدأ مجاناً الآن
                    </Link>
                  </div>
                ...
                {filteredArticles.length > 0 ? (
                  ...
                  <div className="col-span-full py-16 text-center">
                    ...
                    <h4 className="text-lg font-bold text-zinc-400">
                      لم يتم العثور على أي مصادر مطابقة لبحثك
                    </h4>
                    <p className="text-xs text-zinc-500 mt-1">
                      يرجى تعديل مصطلحات البحث أو اختيار فئة تصفح مختلفة.
                    </p>
                  </div>
                )}
              </motion.div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h2 className="text-3xl md:text-5xl font-black text-white leading-tight mb-6">
                  هل منشأتك جاهزة{" "}
                  <span className="text-primary">لتفتيش هيئة الزكاة والموارد البشرية؟</span>
                </h2>
                <p className="text-zinc-400 font-medium leading-relaxed text-sm mb-8">
                  اضمن الامتثال الكامل وتجنب التعليق المفاجئ لخدمات رخص العمل وتأشيرات قوى أو
                  الغرامات المالية للفوترة الإلكترونية من خلال استيفاء بنود الفحص الذاتي التالية.
                </p>
                ...
                <div className="space-y-4">
                  <div className="flex gap-4 items-start">
                    ...
                    <p className="text-sm font-medium text-zinc-300">
                      الربط التلقائي للرواتب ومسيرات مدد مع التأمينات الاجتماعية شهرياً.
                    </p>
                  </div>
                  <div className="flex gap-4 items-start">
                    <CheckCircle className="w-5 h-5 text-emerald-400 shrink-0 mt-0.5" />
                    <p className="text-sm font-medium text-zinc-300">
                      توقيع الفواتير الضريبية الكلية رقمياً وبصيغة XML المتوافقة للمرحلة الثانية.
                    </p>
                  </div>
                  <div className="flex gap-4 items-start">
                    <CheckCircle className="w-5 h-5 text-emerald-400 shrink-0 mt-0.5" />
                    <p className="text-sm font-medium text-zinc-300">
                      حفظ وحماية السجلات المحاسبية والتعاملات من التعديل والتلاعب التاريخي.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-zinc-950/80 border border-white/5 rounded-3xl p-8 relative">
                <div className="flex justify-between items-center mb-6">
                  ...
                  <span className="px-2 py-0.5 bg-primary/20 text-primary text-[10px] font-black rounded-full uppercase">
                    بيتا
                  </span>
                </div>
                ...
                <div className="space-y-6">
                  <div className="bg-zinc-900/40 p-4 rounded-xl border border-white/5">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <button className="px-3 py-2 bg-primary border border-primary/20 text-white rounded-lg text-xs font-black text-center cursor-pointer">
                        محدودة المسؤولية / كبرى
                      </button>
                      <button className="px-3 py-2 bg-white/5 border border-white/5 hover:bg-white/10 text-zinc-400 rounded-lg text-xs font-bold text-center cursor-pointer">
                        فردية / ناشئة
                      </button>
                    </div>
                  </div>
                    ...
                    <div>
                      <div className="flex justify-between text-xs mb-1">
                        <span className="text-zinc-400 font-bold">
                          جاهزية تكامل المنصات (قوى/مدد/موسان)
                        </span>
      ...
      <footer
        className="bg-zinc-950 py-12 border-t border-white/5 text-center text-zinc-500 font-medium"
        dir="rtl"
      >
