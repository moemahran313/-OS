...
export default function Demo() {
  ...
  return (
    <div
      className="min-h-screen bg-zinc-950 font-sans antialiased text-white selection:bg-primary/30"
      dir="rtl"
    >
        ...
        <div className="container mx-auto px-6 max-w-5xl">
          ...
          >
            ...
            <p className="text-xl text-zinc-400 font-medium max-w-2xl mx-auto">
              تصفح الواجهات التفاعلية واكتشف كيف يبدو العمل عند تحويل الفوضى إلى تدفق أوتوماتيكي.
              (بدون تسجيل)
            </p>
          </motion.div>
          ...
          <div className="space-y-12">
            {[
              {
                title: "ديمو الفاتورة الذكية",
                subtitle: "كيف تحول طلب واتساب إلى فاتورة ومحصلة في ثوانٍ",
                color: "from-blue-500/20 to-transparent",
                border: "border-blue-500/30",
              },
              {
                title: "ديمو إدارة العملاء (CRM)",
                subtitle: "تتبع حالة العميل من الاهتمام وحتى إتمام البيع",
                color: "from-emerald-500/20 to-transparent",
                border: "border-emerald-500/30",
              },
              {
                title: "ديمو المساعد الاصطناعي",
                subtitle: "إجابات فورية وتقارير مالية لحظية بالنصوص",
              ...
              >
                <div
                  className={`absolute top-0 right-0 w-full h-full bg-gradient-to-bl ${demo.color} opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none`}
                />
