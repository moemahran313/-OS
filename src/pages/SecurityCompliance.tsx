    ...
    approvers: [
      {
        ...
        name: "أ. سارة الحربي",
        signed: true,
        signedAt: "2026-05-10 10:14",
      },
      {
        role: "مدير الامتثال (CCO)",
        name: "د. يوسف الغامدي",
        signed: true,
        signedAt: "2026-05-11 14:32",
      },
      {
        role: "الرئيس التنفيذي (CEO)",
        name: "م. خالد السديري",
        signed: true,
        signedAt: "2026-05-12 09:00",
      },
    ],
    quizzes: [
      {
...
3. تلتزم الأطراف الخارجية بتوقيع اتفاقية حظر إفشاء أسرار (NDA) مسبقة وملزمة.`,
    ...
    approvers: [
      {
        role: "المشتريات والتعاقدات",
        name: "أ. فيصل العتيبي",
        signed: true,
        signedAt: "2026-06-18 11:40",
      },
...
const INITIAL_EVIDENCE: Evidence[] = [
  {
    id: "ev-1",
    name: "تقرير فحص الثغرات السنوي (Penetration Test Report 2026)",
    controlCode: "CTRL-SEC-04",
    type: "PDF",
    size: "2.4 MB",
    owner: "م. فهد الدوسري",
    expiryDays: 120,
  ...
  {
    id: "ev-2",
    name: "سجلات تفعيل المصادقة الثنائية لجميع حسابات المسؤولين",
    controlCode: "CTRL-MFA-01",
    type: "JSON Logs",
    size: "512 KB",
    owner: "م. عبد الله المطيري",
    expiryDays: 14,
    status: "warning",
  },
  {
    id: "ev-3",
    name: "شهادة الاعتماد لمعيار ISO 27001:2022 المحدثة",
    controlCode: "CTRL-GOV-01",
    type: "PDF",
    size: "4.1 MB",
    owner: "د. يوسف الغامدي",
    expiryDays: -5,
    status: "expired",
  },
  {
    id: "ev-4",
    name: "شهادة الربط المعتمدة لمرحلة التكامل والربط مع ZATCA",
    controlCode: "CTRL-TAX-09",
    type: "XML Credentials",
    size: "12 KB",
    owner: "أ. رامي القحطاني",
    expiryDays: 245,
    status: "compliant",
  },
];
...
const INITIAL_VENDORS: Vendor[] = [
  {
    id: "v-1",
    name: "أمازون لخدمات الويب (AWS Saudi Arabia)",
    piiHandled: true,
    score: 92,
    tier: "Low",
    status: "Active",
  ...
  {
    id: "v-2",
    name: "شركة التقنيات الوطنية المحدودة",
    piiHandled: true,
    score: 71,
    tier: "Medium",
    status: "Reviewing",
  ...
  {
    id: "v-3",
    name: "بوابة الدفع الدولية الذكية",
    piiHandled: true,
    score: 48,
    tier: "High",
    status: "Pending",
...
const INITIAL_LEDGER: AuditBlock[] = [
  {
    sequence: 1,
    timestamp: "2026-06-27T10:00:15Z",
    action: "INITIAL_GENESIS_BLOCK",
    actor: "SYSTEM",
    ip: "127.0.0.1",
  ...
  {
    sequence: 2,
    timestamp: "2026-06-27T10:05:32Z",
    action: "POLICY_APPROVED: pol-1 (v2.4)",
    actor: "y.ghamdi@enterprise.com",
    ip: "192.168.1.14",
    prevHash: "",
    hash: "",
  },
  {
    sequence: 3,
    timestamp: "2026-06-27T10:12:45Z",
    action: "EVIDENCE_UPLOAD: Pen-Test-2026.pdf",
    actor: "f.dosari@enterprise.com",
    ip: "192.168.1.82",
    prevHash: "",
    hash: "",
  },
  {
    sequence: 4,
    timestamp: "2026-06-27T11:22:10Z",
    action: "ZATCA_CSID_AUTORENEWAL: Successful",
    actor: "SYSTEM_DAEMON",
    ip: "10.0.4.15",
    prevHash: "",
    hash: "",
...
export default function SecurityCompliance() {
  ...
  const [activeMainTab, setActiveMainTab] = useState<
    "overview" | "policies" | "evidence" | "workflows" | "whistleblower" | "trust"
  >("overview");
  ...
  >([
    {
      id: "n-1",
      label: "كشف ثغرة أو تحديث تشريعي",
      type: "trigger",
      sla: "0s",
      status: "completed",
    },
    {
      id: "n-2",
      label: "تحليل الأثر بواسطة الذكاء الاصطناعي",
      type: "ai_process",
      sla: "2 mins",
      status: "completed",
    },
    {
      id: "n-3",
      label: "موافقة المستشار القانوني",
      type: "approval",
      sla: "24 hours",
      status: "active",
    },
    {
      id: "n-4",
      label: "اعتماد مدير الامتثال النهائي",
      type: "approval",
      sla: "48 hours",
      status: "idle",
    },
  ...
  const [whistleLogs, setWhistleLogs] = useState<
    Record<string, { sender: string; msg: string; time: string }[]>
  >({});
  ...
  const [selectedRiskCoordinate, setSelectedRiskCoordinate] = useState<{
    l: number;
    i: number;
  } | null>(null);
  ...
  const riskEvents = useMemo(
    () => [
      {
        title: "عدم كفاية إثبات حماية الأجور (WPS) للشهر الماضي",
        l: 4,
        i: 5,
      ...
      {
        title: "تأخر تجديد شهادة الآيزو ISO 27001",
        l: 5,
        i: 4,
        category: "Governance",
        severity: "Critical",
      ...
      {
        title: "المصادقة الثنائية غير مفعلة لبعض حسابات الموردين المؤقتين",
        l: 3,
        i: 4,
      ...
      {
        title: "استضافة بيانات غير حرجة في خادم سحابي أوروبي",
        l: 2,
        i: 3,
      ...
      {
        title: "مسودة سياسة الطرف الثالث لم توقع من الرئيس التنفيذي بعد",
        l: 3,
        i: 2,
        category: "Process",
        severity: "Low",
  ...
  const filteredRisks = useMemo(() => {
    ...
    return riskEvents.filter(
      (r) => r.l === selectedRiskCoordinate.l && r.i === selectedRiskCoordinate.i
    );
  ...
  const triggerMockAudit = () => {
    ...
    setAuditScore(null);
    addLedgerEvent(
      `MOCK_AUDIT_STARTED: ${auditFramework.toUpperCase()}`,
      "y.ghamdi@enterprise.com"
    );
  ...
  const simulateDatabaseTamper = () => {
    ...
    toast.warning(
      'محاكاة هجوم: قام مخترق بتعديل السجل الثاني مباشرة في قاعدة البيانات. انقر "التحقق من سلامة السلسلة" لاختبار الكشف!'
    );
  };
  ...
  const handleVendorOnboardingSubmit = (e: React.FormEvent) => {
    ...
    addLedgerEvent(
      `VENDOR_ONBOARDED: ${newVendorName} (Risk score: ${score})`,
      "purchasing@enterprise.com"
    );
  ...
  const handleWhistleSubmit = (e: React.FormEvent) => {
    ...
    setWhistleLogs((prev) => ({
      ...
      [token]: [
        {
          sender: "CCO_INVESTIGATOR",
          msg: "مرحباً بك، تم استلام بلاغك السري وجاري التحقق من التفاصيل والبيانات المرفقة دون أي كشف لهويتك. كيف يمكننا التواصل لمزيد من الاستفسارات؟",
          time: "الآن",
        },
      ],
    }));
    ...
    setTimeout(() => {
      setWhistleLogs((prev) => ({
        ...
        [activeTok]: [
          ...
          {
            sender: "CCO_INVESTIGATOR",
            msg: `تم استلام توضيحك الإضافي: "${text.slice(0, 20)}...". شكراً لتعاونك في حماية نزاهة وشفافية المنشأة.`,
            time: "الآن",
          },
        ],
      }));
  ...
  const handleQuizSubmit = () => {
    ...
    if (passed) {
      toast.success(
        `تهانينا! لقد اجتزت الاختبار بنجاح بمعدل ${score}% تم تسجيل إقرار الالتزام آلياً.`
      );
      addLedgerEvent(
        `ATTESTATION_COMPLETED: User signed ${activePolicy.title} (v${activePolicy.version})`,
        "moemahran@gmail.com"
      );
    } else {
      toast.error(
        `للأسف لم تجتز الاختبار. النتيجة: ${score}% (الحد الأدنى المطلوب: 80%). يرجى إعادة المحاولة.`
      );
    }
  };
  ...
  const handleAuditExport = () => {
    toast.loading(
      "جاري تجميع وتشفير ملفات التدقيق الأمني لـ " +
        (settings.language === "ar" ? "الجهة الرقابية" : "Regulatory Body") +
        "..."
    );
    setTimeout(() => {
      toast.dismiss();
      toast.success(
        "تم توليد ملف ZIP بنجاح! يحتوي على 14 دليلاً مشفراً بـ SHA-256 مع سجل إثبات الامتثال."
      );
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between border-b border-zinc-200 pb-6 gap-4">
        <div>
          ...
          <h1 className="text-3xl font-black text-zinc-900 mt-2 flex items-center gap-3">
            <ShieldCheck className="w-8 h-8 text-emerald-500" /> مركز الامتثال والتحكم الموحد
            (Compliance Hub)
          </h1>
          <p className="text-zinc-500 mt-2 font-medium">
            لوحة حماية ممتثلة تماماً لهيئة سدايا (SDAIA)، نظام حماية البيانات الشخصية (PDPL)، والربط
            مع هيئة الزكاة (ZATCA).
          </p>
        </div>
                  ...
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <p className="text-[11px] text-zinc-500 mt-1 font-medium flex items-center gap-1">
                        <CheckCircle2 className="w-3 h-3 text-emerald-500" /> آمن ومستمر بموجب 24
                        بند أوتوماتيكي
                      </p>
                    </div>
                ...
                <div className="bg-white p-6 rounded-2xl border border-zinc-200 shadow-sm relative overflow-hidden">
                  ...
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <p className="text-[11px] text-zinc-500 mt-1 font-medium flex items-center gap-1">
                        <Clock className="w-3 h-3 text-amber-500 animate-pulse" /> وثيقة أدلة متبقي
                        لها 14 يوماً
                      </p>
                    </div>
                  ...
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <p className="text-[11px] text-zinc-500 mt-1 font-medium">
                        96/110 موظف أتموا التوقيع القانوني
                      </p>
                    </div>
                ...
                <div className="bg-white p-6 rounded-2xl border border-zinc-200 shadow-sm lg:col-span-2">
                  <div className="mb-4">
                    <h3 className="text-md font-black text-zinc-900 flex items-center gap-2">
                      <Layers className="w-4 h-4 text-emerald-500" /> مصفوفة المخاطر التفاعلية 5x5
                      (Risk Assessment Matrix)
                    </h3>
                    <p className="text-xs text-zinc-500 mt-1">
                      انقر على أي مربع إحداثيات لرؤية وفلترة المخاطر المطابقة بناءً على (الاحتمالية
                      × الأثر).
                    </p>
                  </div>
                          ...
                          {Array.from({ length: 5 }, (_, rIdx) => {
                            ...
                            return Array.from({ length: 5 }, (_, cIdx) => {
                              ...
                              if (severityScore >= 15) {
                                ...
                                cellBg =
                                  "bg-yellow-50/50 hover:bg-yellow-100 border-yellow-100 text-yellow-700";
                              }

                              const activeDots = riskEvents.filter(
                                (e) => e.l === likelihood && e.i === impact
                              );
                              const isSelected =
                                selectedRiskCoordinate?.l === likelihood &&
                                selectedRiskCoordinate?.i === impact;

                              return (
                                <button
                                  key={`${likelihood}-${impact}`}
                                  onClick={() =>
                                    setSelectedRiskCoordinate(
                                      isSelected ? null : { l: likelihood, i: impact }
                                    )
                                  }
                                  className={`relative border rounded-lg flex flex-col items-center justify-center transition-all cursor-pointer ${cellBg} ${
                                    isSelected
                                      ? "ring-2 ring-zinc-800 ring-offset-2 scale-95 shadow-md"
                                      : ""
                                  }`}
                      ...
                      <div className="p-4 bg-zinc-50 border border-zinc-200 rounded-xl">
                        ...
                        <div className="space-y-3.5 max-h-48 overflow-y-auto pr-1">
                          {filteredRisks.map((risk, idx) => (
                            <div
                              key={idx}
                              className="p-3 bg-white border border-zinc-150 rounded-lg text-xs hover:shadow-sm transition-all"
                            >
                          ...
                          {filteredRisks.length === 0 && (
                            <p className="text-center text-zinc-400 py-6 text-xs font-medium">
                              لا توجد مخاطر مسجلة في هذا المربع.
                            </p>
                          )}
                        </div>
                      </div>
                ...
                <div className="bg-white p-6 rounded-2xl border border-zinc-200 shadow-sm flex flex-col justify-between">
                  <div>
                    <h3 className="text-md font-black text-zinc-900 flex items-center gap-2 mb-4">
                      <CheckCircle2 className="w-4 h-4 text-indigo-500" /> مركز المهام والتشغيل
                      (User Task Center)
                    </h3>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start gap-3 p-3 bg-rose-50/50 border border-rose-100 rounded-xl">
                        ...
                        <div>
                          <h4 className="text-xs font-bold text-zinc-900 leading-tight">
                            تجديد شهادة الآيزو ISO 27001
                          </h4>
                          <p className="text-[10px] text-zinc-500 mt-1">
                            انتهت الصلاحية قبل 5 أيام - يلزم إعادة رفع المستند.
                          </p>
                          <button
                      ...
                      <div className="flex items-start gap-3 p-3 bg-amber-50/50 border border-amber-100 rounded-xl">
                        ...
                        <div>
                          <h4 className="text-xs font-bold text-zinc-900 leading-tight">
                            إقرار سياسة TPRM المحدثة
                          </h4>
                          <p className="text-[10px] text-zinc-500 mt-1">
                            معلق - يتطلب مراجعة وقراءة واجتياز الاختبار القصير.
                          </p>
                          <button
                            onClick={() => {
                      ...
                      <div className="flex items-start gap-3 p-3 bg-zinc-50 border border-zinc-200 rounded-xl">
                        ...
                        <div>
                          <h4 className="text-xs font-bold text-zinc-900 leading-tight">
                            استبيان مراجعة أمن الموردين
                          </h4>
                          <p className="text-[10px] text-zinc-500 mt-1">
                            تلقى استبياناً أمنياً جديداً من شركة الدفع بوابة الدفع.
                          </p>
                          <button
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
                  <div className="space-y-2">
                    <h3 className="text-xl font-black flex items-center gap-2">
                      <Download className="w-5 h-5 text-emerald-400" /> مولد حزمة التدقيق والامتثال
                      الذكي (Audit Binder Generator)
                    </h3>
                    <p className="text-sm text-zinc-300 font-medium max-w-3xl leading-relaxed">
                      قم بإنشاء وتنزيل ملف ZIP مشفر يحتوي على كافة السياسات الموقعة، سجلات الكتل
                      المشفرة للتدقيق، وملفات الأدلة المستمدة من الخوادم، جاهزة تماماً لتقديمها
                      لمدققي SOC 2 أو هيئة سدايا بشكل فوري.
                    </p>
                    ...
                    <div className="flex flex-wrap gap-4 pt-3 text-xs font-bold text-zinc-400">
                      <label className="flex items-center gap-2 cursor-pointer hover:text-white transition-colors">
                        <input
                          type="checkbox"
                          defaultChecked
                          className="rounded border-zinc-600 text-emerald-500 focus:ring-emerald-500 bg-zinc-800"
                        />
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white p-5 rounded-2xl border border-zinc-200 shadow-sm">
                  <h3 className="text-sm font-black text-zinc-900 mb-4 flex items-center gap-2">
                    <FileText className="w-4 h-4 text-emerald-500" /> مستندات الحوكمة واللوائح
                    الداخلية
                  </h3>
                ...
                <div className="bg-zinc-900 text-white p-6 rounded-2xl shadow-lg relative overflow-hidden">
                  ...
                  <div className="flex justify-between items-center mb-4">
                    <h3 className="text-sm font-black flex items-center gap-2">
                      <Cpu className="w-4.5 h-4.5 text-indigo-400 animate-pulse" /> التغذية
                      التنظيمية الذكية (AI Ingestion)
                    </h3>
                  ...
                  <p className="text-[11px] text-zinc-400 mb-4 leading-relaxed">
                    يقوم محرك الذكاء الاصطناعي بمسح مستمر للصحف الرسمية ووزارة العدل وهيئة سدايا
                    للكشف عن أي تغيير تشريعي وتطبيق محاكاة الأثر.
                  </p>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="p-3.5 bg-zinc-850 border border-zinc-800 rounded-xl relative">
                      ...
                      <p className="text-[10px] text-zinc-400 leading-normal">
                        يوجب التحديث الحصول على موافقة مشفرة مسبقة من واجهة نفاذ الموحدة قبل معالجة
                        بيانات الموظفين.
                      </p>
                      ...
                      <div className="mt-3.5 pt-3.5 border-t border-zinc-800 space-y-2">
                        <div className="flex items-center gap-1.5 text-[10px] text-indigo-300 font-bold">
                          <Info className="w-3.5 h-3.5" /> تعديل قانوني مقترح بواسطة الذكاء
                          الاصطناعي:
                        </div>
                ...
                <div className="bg-white p-6 rounded-2xl border border-zinc-200 shadow-sm">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between border-b border-zinc-100 pb-4 mb-4 gap-4">
                    <div>
                      ...
                      <p className="text-xs text-zinc-400 mt-1">
                        الإصدار {activePolicy.version} | آخر تحديث: {activePolicy.lastUpdated}
                      </p>
                    </div>
                    ...
                    <div className="space-y-6 p-4 bg-emerald-50/30 border border-emerald-100 rounded-2xl">
                      <div className="flex items-center gap-2 border-b border-emerald-100 pb-3">
                        ...
                        <div>
                          <h3 className="text-xs font-black text-zinc-900">
                            الاختبار التدريبي الإلزامي للالتزام بالسياسة
                          </h3>
                          <p className="text-[10px] text-zinc-500 mt-0.5">
                            يتطلب توقيع إقرار الالتزام الحصول على درجة 80% أو أكثر في هذا التقييم.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="space-y-6">
                        {activePolicy.quizzes.map((q, qIdx) => (
                          <div
                            key={qIdx}
                            className="space-y-3 bg-white p-4 rounded-xl border border-zinc-200"
                          >
                          ...
                          {quizResult.passed ? (
                            <>
                              ...
                              <h4 className="text-sm font-black">
                                تهانينا! لقد اجتزت الاختبار التدريبي
                              </h4>
                              <p className="text-xs">
                                النتيجة: {quizResult.score}% | تم تسجيل إقرار الامتثال والتوقيع في
                                سلسلة الكتل بنجاح.
                              </p>
                            </>
                          ) : (
                            <>
                              ...
                              <p className="text-xs">
                                النتيجة: {quizResult.score}% | يرجى مراجعة بنود السياسة والمحاولة
                                مجدداً لتحقيق الحد الأدنى (80%).
                              </p>
                              <button
                                onClick={() => {
                                  setQuizAnswers({});
                    ...
                    <div className="space-y-4">
                      <div className="p-3 bg-zinc-50 border border-zinc-200 rounded-xl text-[10px] font-mono text-zinc-600">
                        <p className="font-bold text-zinc-800 mb-1">
                          تتبع التعديلات (Git Revisions Diff)
                        </p>
                        <p>
                          تتم مقارنة الإصدار الحالي {activePolicy.version} مع الإصدار السابق 2.3
                          للسياسة.
                        </p>
                      </div>
                      ...
                      <div className="font-mono text-xs border border-zinc-200 rounded-xl overflow-hidden divide-y divide-zinc-200">
                        <div className="p-3 bg-rose-50 text-rose-800 flex justify-between gap-4">
                          <span>
                            - يُحظر مشاركة أو نقل بيانات العملاء السحابية خارج النطاق الفيدرالي.
                          </span>
                        ...
                        <div className="p-3 bg-emerald-50 text-emerald-800 flex justify-between gap-4">
                          <span>
                            + يُحظر مشاركة أو تصدير أي بيانات حساسة خارج النطاق الجغرافي للمملكة
                            بدون موافقة صريحة من سدايا.
                          </span>
                        ...
                        <div className="p-3 bg-zinc-50 text-zinc-700">
                          <span>
                            {" "}
                            التشديد على التشفير الكامل للبيانات في السكون والحركة باستخدام خوارزمية
                            AES-256.
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="p-4 bg-zinc-50 border border-zinc-200 rounded-xl space-y-2">
                        <h4 className="text-xs font-bold text-zinc-800">
                          مبرر التغيير الحالي (Change Rationale):
                        </h4>
                        <p className="text-xs text-zinc-600">
                          "تحديث صياغة البند الثاني ليتوافق بدقة مع المادة 24 من اللائحة التنفيذية
                          لنظام حماية البيانات الشخصية الصادر عن الهيئة السعودية للبيانات والذكاء
                          الاصطناعي (سدايا)."
                        </p>
                      </div>
                    </div>
                      ...
                      <div className="flex justify-between items-center text-xs">
                        ...
                        <button
                          onClick={() => {
                            ...
                            addLedgerEvent(
                              `POLICY_EDITED: ${activePolicy.title}`,
                              "moemahran@gmail.com"
                            );
                  ...
                  <div className="mt-8 border-t border-zinc-100 pt-6">
                    <h3 className="text-xs font-black text-zinc-900 mb-4 flex items-center gap-2">
                      <FileSignature className="w-4 h-4 text-emerald-500" /> مسار الاعتمادات
                      والتوقيع الرقمي المتسلسل (eIDAS Standard)
                    </h3>
                            ...
                            {appr.signed ? (
                              ...
                              <button
                                onClick={() => {
                                  ...
                                  addLedgerEvent(
                                    `POLICY_APPROVED_BY_STAKEHOLDER: ${appr.role} for ${activePolicy.title}`,
                                    "moemahran@gmail.com"
                                  );
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white p-6 rounded-2xl border border-zinc-200 shadow-sm">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between border-b border-zinc-150 pb-4 mb-4 gap-4">
                  <div>
                    <h3 className="text-md font-black text-zinc-900 flex items-center gap-2">
                      <Server className="w-4.5 h-4.5 text-emerald-500" /> سجل سلسلة الكتل للتدقيق
                      غير القابل للتلاعب (Immutable Cryptographic Ledger)
                    </h3>
                    <p className="text-xs text-zinc-500 mt-1">
                      كل عملية تعديل أو توقيع تولد كتلة مشفرة بـ SHA-256 تحتوي على البصمة الزمنية
                      وقيمة الكتلة السابقة (Chain of Custody).
                    </p>
                  </div>
                  ...
                  <div className="flex gap-2">
                    ...
                    >
                      <AlertTriangle className="w-3.5 h-3.5 animate-pulse" /> محاكاة اختراق وتعديل
                      السجلات (Red Team Hack)
                    </button>
                  ...
                  >
                    {verificationResult === "verified" ? (
                      <>
                        ...
                        <div>
                          <h4 className="text-xs font-black">
                            السلسلة سليمة وموثقة (Ledger Verified Integrity)
                          </h4>
                          <p className="text-[10px] opacity-90 mt-0.5">
                            تم التحقق من كافة هتاش كتل السجل بالتطابق مع السجلات السابقة. لا يوجد أي
                            كسر في السلسلة.
                          </p>
                        </div>
                      </>
                      ...
                      <>
                        ...
                        <div>
                          <h4 className="text-xs font-black">
                            تم الكشف عن تلاعب بالبيانات (LEDGER BREACH DETECTED)
                          </h4>
                          <p className="text-[10px] opacity-90 mt-0.5">
                            مفتاح كتلة التعديل لا يطابق البصمة السابقة! تم تمييز السجلات المتأثرة
                            باللون الأحمر فوراً.
                          </p>
                        </div>
                      </>
                    ...
                    <tbody className="divide-y divide-zinc-100">
                      {ledger.map((block) => (
                        ...
                        >
                          ...
                          <td className="px-4 py-3 truncate max-w-[120px]" title={block.prevHash}>
                            {block.prevHash}
                          </td>
                          <td
                            className={`px-4 py-3 truncate max-w-[140px] font-black ${block.tampered ? "text-rose-600" : "text-emerald-600"}`}
                            title={block.hash}
                          >
                            {block.hash}
                          </td>
                  ...
                  <div className="flex justify-between items-center mb-6">
                    <div>
                      <h3 className="text-sm font-black text-zinc-900 flex items-center gap-2">
                        <Layers className="w-4.5 h-4.5 text-emerald-500" /> مستودع الأدلة المستمرة
                        والأثبات (Continuous Evidence Vault)
                      </h3>
                      <p className="text-xs text-zinc-500 mt-1">
                        تنبيهات صلاحية مسبقة بـ 30 يوماً لضمان عدم حدوث أي ثغرة في الامتثال للأجهزة
                        التدقيقية.
                      </p>
                    </div>
                    ...
                    <button
                      onClick={() => {
                        ...
                        toast.success(
                          "تم رفع مستند دليل أمني جديد بنجاح وتأمينه في خادم الأمان WORM!"
                        );
                      }}
                  ...
                  <div className="space-y-3">
                    {evidenceList.map((ev) => {
                      ...
                      return (
                        <div
                          key={ev.id}
                          className="p-4 bg-zinc-50 border border-zinc-200 rounded-xl flex flex-col md:flex-row md:items-center md:justify-between gap-4"
                        >
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-[10px] text-zinc-500 mt-1 font-medium">
                                المعيار: <strong className="text-zinc-800">{ev.controlCode}</strong>{" "}
                                | المالك المسؤول: {ev.owner}
                              </p>
                              <p className="text-[10px] text-zinc-400 mt-0.5">
                                نوع الملف: {ev.type} | الحجم: {ev.size}
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center justify-between md:justify-end gap-3 border-t md:border-t-0 pt-3 md:pt-0 border-zinc-200">
                            <div className="text-left md:text-right">
                              <span
                                className={`inline-flex items-center gap-1 border px-2 py-0.5 rounded-full text-[9px] font-black ${statusBadge}`}
                              >
                              ...
                              <p className="text-[9px] text-zinc-400 font-medium mt-1">
                                {ev.expiryDays < 0
                                  ? `منتهي منذ ${Math.abs(ev.expiryDays)} يوم`
                                  : `ينتهي بعد ${ev.expiryDays} يوم`}
                              </p>
                            </div>
                              ...
                              <button
                                onClick={() => {
                                  setEvidenceList((prev) =>
                                    prev.map((e) =>
                                      e.id === ev.id
                                        ? { ...e, expiryDays: 365, status: "compliant" }
                                        : e
                                    )
                                  );
                                  addLedgerEvent(
                                    `EVIDENCE_RENEWED: ${ev.name}`,
                                    "moemahran@gmail.com"
                                  );
                                  toast.success(
                                    "تم تجديد مستند الدليل بنجاح وإعادة عداد الامتثال لـ 365 يوماً!"
                                  );
                                }}
                ...
                <div className="bg-white p-6 rounded-2xl border border-zinc-200 shadow-sm flex flex-col justify-between">
                  <div>
                    <h3 className="text-sm font-black text-zinc-900 flex items-center gap-2 mb-2">
                      <Cpu className="w-4.5 h-4.5 text-indigo-500 animate-pulse" /> محاكي التدقيق
                      والجاهزية بنقرة واحدة (Mock Audit Simulator)
                    </h3>
                    <p className="text-xs text-zinc-500 mb-4">
                      اختبر جاهزيتك فوراً أمام الجهات الرقابية واحصل على نقاط فحص الثغرات والحلول
                      المقترحة.
                    </p>
                      ...
                      <div className="space-y-4 py-8 flex flex-col items-center justify-center text-center">
                        ...
                        <div className="space-y-1 w-full max-w-[180px]">
                          <p className="text-xs font-bold text-zinc-800">
                            جاري فحص وتدقيق السجلات والتحقق من الكتل...
                          </p>
                      ...
                      <div className="space-y-5 py-4">
                        <div className="flex flex-col items-center text-center gap-1">
                          <span className="text-[10px] font-black text-zinc-400 uppercase">
                            النسبة المتوقعة للجاهزية
                          </span>
                          <h4
                            className={`text-4xl font-black ${auditScore >= 80 ? "text-emerald-600" : "text-amber-500"}`}
                          >
                            {auditScore}%
                          </h4>
                          <span
                            className={`text-[9px] font-black border px-2 py-0.5 rounded-full mt-1.5 ${
                              auditScore >= 80
                        ...
                        <div className="space-y-2">
                          <h4 className="text-[11px] font-black text-zinc-700">
                          ...
                          <div className="space-y-2 max-h-32 overflow-y-auto pr-1">
                            {evidenceList
                              ...
                              .map((ev) => (
                                <div
                                  key={ev.id}
                                  className="p-2.5 bg-rose-50/50 border border-rose-100 rounded-lg text-[10px]"
                                >
                                  <div className="flex justify-between items-center font-bold">
                                    <span className="text-rose-700">
                                      دليل منتهي الصلاحية: {ev.controlCode}
                                    </span>
                                    <button
                                      onClick={() => {
                                        setEvidenceList((prev) =>
                            ...
                            {evidenceList.filter((e) => e.status !== "compliant").length === 0 && (
                              <p className="text-center text-emerald-600 font-bold text-[10px] py-4">
                                تهانينا! لا توجد فجوات متبقية.
                              </p>
                            )}
                          </div>
                        </div>
            ...
            <div className="space-y-8">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 bg-white p-6 rounded-2xl border border-zinc-200 shadow-sm">
                  <div className="mb-4">
                    <h3 className="text-sm font-black text-zinc-900 flex items-center gap-2">
                      <Cpu className="w-4.5 h-4.5 text-emerald-500" /> مخطط الأتمتة ومسارات الامتثال
                      التفاعلي (Compliance Workflow Canvas)
                    </h3>
                    <p className="text-xs text-zinc-500 mt-1">
                      انقر لتنشيط الخطوات لمشاهدة كيف تتدفق إشارات الامتثال مع المراقبة الدقيقة لـ
                      SLAs.
                    </p>
                  </div>
                  ...
                  <div className="relative p-6 bg-zinc-50 border border-zinc-200 rounded-2xl overflow-hidden min-h-[300px] flex flex-col justify-between">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4 relative z-10 w-full py-6">
                      {workflowNodes.map((node, index) => {
                        ...
                        if (node.status === "completed") {
                          ...
                          nodeColor =
                            "bg-indigo-50 border-indigo-300 text-indigo-800 ring-4 ring-indigo-500/20";
                        }

                        return (
                          <React.Fragment key={node.id}>
                            <div
                              className={`p-4 rounded-xl border text-center flex flex-col gap-1 w-full md:w-44 shadow-sm transition-all ${nodeColor}`}
                            >
                              ...
                              <h4 className="text-[11px] font-black leading-tight mt-1">
                                {node.label}
                              </h4>
                              <span className="text-[9px] font-mono mt-1.5 opacity-85">
                                SLA: {node.sla}
                              </span>
                            </div>
                    ...
                    <div className="flex justify-between items-center border-t border-zinc-200/80 pt-4 text-xs font-bold">
                      <span className="text-zinc-400">
                        تنبيهات التصعيد التلقائية نشطة (Slack / Teams Escalation)
                      </span>
                      ...
                      <button
                        onClick={() => {
                          ...
                          addLedgerEvent(
                            "WORKFLOW_STEP_APPROVED: Stakeholder review approved for automated SLA flow",
                            "y.ghamdi@enterprise.com"
                          );
                        }}
                ...
                <div className="bg-white p-6 rounded-2xl border border-zinc-200 shadow-sm">
                  <div className="mb-4">
                    <h3 className="text-sm font-black text-zinc-900 flex items-center gap-2">
                      <Building className="w-4.5 h-4.5 text-indigo-500" /> تقييم مخاطر الموردين
                      الجدد (TPRM Smart Form)
                    </h3>
                    <p className="text-xs text-zinc-500 mt-1">
                      يتحرك حقل معالجة البيانات الشخصية لفتح 10 أسئلة إضافية آلياً في حال التفعيل.
                    </p>
                  </div>
                  ...
                  <form onSubmit={handleVendorOnboardingSubmit} className="space-y-4">
                    ...
                    <div className="flex items-center justify-between p-3 bg-zinc-50 border border-zinc-150 rounded-xl">
                      <div className="flex gap-2 items-center">
                        ...
                        <span className="text-xs font-bold text-zinc-700">
                          هل يعالج المورد بيانات عملاء شخصية؟ (PII)
                        </span>
                      </div>
                      <button
                        type="button"
                      ...
                      >
                        <span
                          className={`inline-block h-3.5 w-3.5 transform rounded-full bg-white transition-transform ${vendorPii ? "-translate-x-4.5" : "-translate-x-1"}`}
                        />
                      </button>
                    </div>
                    ...
                    <AnimatePresence>
                      {vendorPii && (
                        ...
                        >
                          <div className="space-y-1">
                            <label className="text-[9px] font-black text-indigo-900 block">
                              هل يقوم المورد بتشفير البيانات في قاعدة بياناته؟
                            </label>
                            <select
                              value={vendorEncrypt}
                          ...
                          <div className="space-y-1">
                            ...
                            >
                              <option value="saudi">
                                محلي داخل المملكة العربية السعودية (ممتثل)
                              </option>
              ...
              <div className="bg-white p-6 rounded-2xl border border-zinc-200 shadow-sm">
                <h3 className="text-sm font-black text-zinc-900 mb-4 flex items-center gap-2">
                  <Building className="w-4 h-4 text-emerald-500" /> سجل الطرف الثالث المعتمد والنشط
                  (Active Third-Party Registry)
                </h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {vendors.map((v) => (
                    <div
                      key={v.id}
                      className="p-4 bg-zinc-50 border border-zinc-250 rounded-2xl flex justify-between items-center"
                    >
                      <div>
                        <h4 className="text-xs font-black text-zinc-900">{v.name}</h4>
                        <div className="flex gap-2 items-center mt-2">
                          <span
                            className={`text-[9px] font-black border px-2 py-0.5 rounded-full ${
                              v.tier === "Low"
                                ? "bg-emerald-50 text-emerald-700 border-emerald-100"
                                : v.tier === "Medium"
                                  ? "bg-amber-50 text-amber-700 border-amber-100"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-6 rounded-2xl border border-zinc-200 shadow-sm lg:col-span-1.5 flex flex-col justify-between">
                <div>
                  <div className="mb-6">
                    <h3 className="text-md font-black text-zinc-900 flex items-center gap-2">
                      <EyeOff className="w-5 h-5 text-zinc-900 animate-pulse" /> قناة تقديم البلاغات
                      مجهولة الهوية بالكامل (Confidential Intake Channel)
                    </h3>
                    <p className="text-xs text-zinc-500 mt-2 leading-relaxed">
                      نظام مشفر ومجرد تماماً من ملفات الارتباط (Cookies)، معرفات الأجهزة، وعناوين
                      الـ IP الخاصة بالرافع. يضمن القانون الحماية المطلقة لسرية المبلغين.
                    </p>
                  </div>
                  ...
                  <form onSubmit={handleWhistleSubmit} className="space-y-4">
                    <div className="space-y-1">
                      <label className="text-[10px] font-black text-zinc-400 block">
                        تصنيف ونوع المخالفة المشتبه بها
                      </label>
                      <select
                    ...
                    <div className="space-y-1">
                      <label className="text-[10px] font-black text-zinc-400 block">
                        شرح وتفصيل الشكوى والمخالفة الملاحظة
                      </label>
                      <textarea
                    ...
                    <div className="p-3 bg-zinc-50 border border-zinc-150 rounded-xl text-[10px] text-zinc-500 flex items-center gap-2">
                      ...
                      <span>
                        النظام يحذف البيانات الوصفية (Metadata) للملفات المرفقة تلقائياً قبل الحفظ.
                      </span>
                    </div>
              ...
              <div className="bg-white p-6 rounded-2xl border border-zinc-200 shadow-sm lg:col-span-2 flex flex-col justify-between">
                <div>
                  <div className="mb-4">
                    <h3 className="text-sm font-black text-zinc-900 flex items-center gap-2">
                      <Smartphone className="w-4.5 h-4.5 text-indigo-500 animate-pulse" /> بوابة
                      الاتصال السري ثنائي الاتجاه (Confidential Message Relay)
                    </h3>
                    <p className="text-xs text-zinc-500 mt-1">
                      تواصل بأمان تام مع المحققين المعتمدين لرفع أدلة إضافية دون الكشف عن شخصيتك
                      باستخدام الرمز المخصص.
                    </p>
                  </div>
                  ...
                  {activeWhistleToken && (
                    <div className="p-4 bg-emerald-50 border border-emerald-200 rounded-xl mb-4 text-center">
                      <span className="text-[10px] font-black text-emerald-800 block">
                        مفتاح المتابعة السري الخاص بك (انسخه واحفظه جيداً):
                      </span>
                    ...
                    {activeWhistleChatToken || activeWhistleToken ? (
                      <div className="p-4 bg-zinc-900 text-white rounded-2xl min-h-[220px] flex flex-col justify-between">
                        <div className="space-y-3 max-h-48 overflow-y-auto pr-1">
                          {(
                            whistleLogs[activeWhistleChatToken || activeWhistleToken || ""] || []
                          ).map((msg, mIdx) => {
                            ...
                            return (
                              ...
                              >
                                ...
                                <div
                                  className={`p-2.5 rounded-xl text-xs ${isMe ? "bg-indigo-600 text-white rounded-br-none" : "bg-zinc-800 text-zinc-100 rounded-bl-none"}`}
                                >
                                  {msg.msg}
                                </div>
                              </div>
                      ...
                      <div className="border border-zinc-200 border-dashed rounded-2xl p-8 text-center text-zinc-400 text-xs py-12">
                        يرجى تقديم بلاغ لتوليد رمز أو إدخال رمز متابعة سابق لعرض محادثة قناة النزاهة
                        المشفرة.
                      </div>
                    )}
                  </div>
              ...
              <div className="bg-zinc-50 border border-zinc-200 rounded-2xl p-6 mb-8 relative overflow-hidden">
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  <div>
                    ...
                    <p className="text-xs text-zinc-500 mt-1">
                      بوابة ترويجية للثقة تعرض الأمان والاعتمادات لعملاء ومستثمري الشركة لتقليص مدة
                      مراجعة الصفقات.
                    </p>
                  </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="space-y-4">
                  <h4 className="text-xs font-black text-zinc-800 uppercase tracking-widest">
                    الشارات والاعتمادات النشطة (Security Badges)
                  </h4>
                  ...
                  <div className="p-4 bg-emerald-50/50 border border-emerald-100 rounded-2xl flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="text-xs font-black text-zinc-900">
                        سدايا ومجلس حماية البيانات (PDPL)
                      </h4>
                      <p className="text-[10px] text-zinc-500 mt-0.5">
                        ممتثل ومحدث جغرافياً وفق المعايير الإلزامية.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="p-4 bg-emerald-50/50 border border-emerald-100 rounded-2xl flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-zinc-500 mt-0.5">
                        تقييم كامل لمبادئ السرية والتوافر والأمان.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="p-4 bg-emerald-50/50 border border-emerald-100 rounded-2xl flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-zinc-500 mt-0.5">
                        تأمين دورة نظام المعلومات والتحكم بالمخاطر.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="lg:col-span-2 space-y-6">
                  <h4 className="text-xs font-black text-zinc-800 uppercase tracking-widest">
                    المستندات الأمنية الحساسة (Gated Security Documents)
                  </h4>

                  <div className="space-y-3">
                    {[
                      {
                        title: "تقرير التدقيق الخارجي الكامل لـ SOC 2 لعام 2026",
                        type: "PDF Report",
                        size: "1.4 MB",
                      },
                      {
                        title: "نتائج فحص واختبار الاختراق الخارجي السنوي",
                        type: "PDF Report",
                        size: "920 KB",
                      },
                      {
                        title: "خريطة البنية التحتية وسياسة مرونة الكوارث والمخاطر السحابية",
                        type: "Architectural Doc",
                        size: "2.1 MB",
                      },
                    ].map((doc, dIdx) => (
                      <div
                        key={dIdx}
                        className="p-4 bg-zinc-50 border border-zinc-200 rounded-xl flex items-center justify-between gap-4"
                      >
                        <div className="flex items-center gap-3">
                        ...
                        <button
                          onClick={() => {
                            toast.warning(
                              "يتطلب تنزيل المستند الأمني الحساس توقيع اتفاقية حظر إفشاء أسرار (NDA) رقمية وملزمة."
                            );
                          }}
                  ...
                  <div className="p-5 bg-zinc-50 border border-zinc-200 rounded-2xl space-y-3">
                    <h5 className="text-xs font-black text-zinc-800 flex items-center gap-1">
                      <FileSignature className="w-4 h-4 text-emerald-500" /> التوقيع التلقائي
                      لاتفاقية عدم الإفشاء (NDA Online Gate)
                    </h5>
                    <p className="text-[11px] text-zinc-500">
                      بإدخال بريدك المؤسسي والنقر أدناه، فإنك توافق رقمياً على الالتزام باتفاقية NDA
                      لشركة التقنية المتقدمة قبل الاطلاع على فحوصات التدقيق.
                    </p>
                    ...
                    <div className="flex flex-col md:flex-row gap-2">
                      ...
                      <button
                        onClick={() => {
                          toast.success(
                            "تم قبول التوقيع على اتفاقية NDA وتنزيل مستند التدقيق المشفر بنجاح!"
                          );
                          addLedgerEvent(
                            "NDA_SIGNED_BY_EXTERNAL_VISITOR: buyer@partner.com signed trust gate NDA",
                            "visitor_guest"
                          );
                        }}
