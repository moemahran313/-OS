  ...
  const openEditModal = (s: Shipment, e: React.MouseEvent) => {
    ...
    setNewShipment({
      ...
      estimatedDeliveryDate: s.estimatedDeliveryDate
        ? new Date(s.estimatedDeliveryDate).toISOString().split("T")[0]
        : "",
      clientId: s.clientId || "",
    });
    setShowAddModal(true);
      ...
      <header className="flex flex-col md:flex-row justify-between items-start md:items-center bg-white p-6 rounded-3xl border border-zinc-100 shadow-sm gap-4 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-zinc-500 font-medium mt-1">
            مدارج ImportOS: نظام ذكي للامتثال الجمركي السعودي.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
                  ...
                  {
                    label: "بانتظار الفسح",
                    value: shipments.filter((s) => s.status !== "cleared").length,
                    color: "amber",
                  },
                  {
                    label: "في الطريق",
                  ...
                  >
                    ...
                    <p
                      className={cn(
                        ...
                        stat.color === "primary" ? "text-primary" : `text-${stat.color}-600`
                      )}
                    >
                      {stat.value}
                    </p>
              ...
              {loading ? (
                ...
                <div className="bg-white rounded-3xl p-20 text-center border border-zinc-100 shadow-sm border-dashed">
                  ...
                  <p className="text-zinc-500 font-medium mb-8">
                    ابدأ بإضافة أول شحنة للموردين لتبدأ مدارج بمتابعتها.
                  </p>
                  <button
                    onClick={() => setShowAddModal(true)}
                    ...
                    >
                      <div className="flex justify-between items-start mb-4">
                        <div className="flex gap-4">
                          ...
                          <div>
                            <h3 className="font-black text-lg text-zinc-900">
                              ...
                              {s.alias && (
                                <span className="mr-2 text-[10px] font-medium text-zinc-400 bg-zinc-50 px-2 py-0.5 rounded border border-zinc-100">
                                  {s.supplierName}
                                </span>
                              )}
                            </h3>
                            <p className="text-xs text-zinc-500 font-medium flex items-center gap-2">
                              {s.countryOfOrigin} <Globe className="w-3 h-3" /> •{" "}
                        ...
                        <div className="px-3 py-1 bg-primary/5 text-primary rounded-full text-[10px] font-black uppercase tracking-wider flex items-center gap-2">
                          <span>
                            {statusSteps.find((step) => step.id === s.status)?.label || s.status}
                          </span>
                          <button
                      ...
                      <div className="mb-6 relative">
                              ...
                              <div key={step.id} className="relative group/step">
                                <div
                                  className={cn(
                                    ...
                                    isActive
                                      ? "bg-primary border-primary shadow-[0_0_8px_rgba(16,185,129,0.5)]"
                        ...
                        <div className="absolute top-1/2 -translate-y-1/2 left-1 right-1 h-px bg-zinc-100 -z-0">
                          <motion.div
                            initial={{ width: 0 }}
                            animate={{
                              width: `${(statusSteps.findIndex((st) => st.id === s.status) / (statusSteps.length - 1)) * 100}%`,
                            }}
                      ...
                      <div className="flex justify-between items-center text-xs font-bold">
                        <div className="flex gap-4">
                          <span className="flex items-center gap-1 text-zinc-400">
                            <FileText className="w-3 h-3" /> {s.documents.length} مستندات
                          </span>
                          <span className="flex items-center gap-1 text-zinc-400">
                            <MessageSquare className="w-3 h-3" /> {s.comments.length} تعليقات
                          </span>
                          {s.clientId && (
                          ...
                          {s.estimatedDeliveryDate && (
                            <span
                              className={cn(
                                ...
                                new Date(s.estimatedDeliveryDate).getTime() < Date.now()
                                  ? "bg-rose-50 text-rose-500 border-rose-100"
                                  : "bg-emerald-50 text-emerald-600 border-emerald-100"
                              )}
                            >
                              <Clock className="w-3 h-3" />
                              {new Date(s.estimatedDeliveryDate).toLocaleDateString("ar-SA", {
                                day: "numeric",
                                month: "short",
                              })}
                            </span>
              ...
              <div className="p-10 md:p-14 relative z-10 space-y-12">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 border-b border-zinc-100 pb-10">
                  <div className="max-w-xl">
                    ...
                    <h2 className="text-4xl md:text-5xl font-black text-zinc-900 mb-4 tracking-tighter leading-tight">
                      محرك الامتثال الذكي
                    </h2>
                    <p className="text-zinc-500 font-medium text-lg leading-relaxed">
                      أدخل تفاصيل البضاعة لمعرفة المتطلبات القانونية والجمارك السعودية بنظام الفحص
                      الفوري.
                    </p>
                  </div>
                  <div className="hidden md:block text-left">
                    <p className="text-[10px] font-black text-zinc-400 uppercase tracking-widest mb-1 leading-none">
                      Last Database Sync
                    </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
                  <div className="space-y-3">
                    <label className="text-xs font-black text-zinc-400 uppercase tracking-[0.15em] px-1 block">
                      وصف المنتج
                    </label>
                    <div className="relative group">
                      <input
                        ...
                        onChange={(e) =>
                          setCompCheckData({ ...compCheckData, desc: e.target.value })
                        }
                      />
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="relative group">
                      <select
                        ...
                        onChange={(e) =>
                          setCompCheckData({ ...compCheckData, country: e.target.value })
                        }
                      >
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      isCompLoading
                        ...
                        : "hover:scale-[1.01] active:scale-[0.98] hover:bg-black"
                    )}
                  >
                    ...
                    >
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-12 border-t border-dashed border-zinc-200">
                        ...
                        >
                          ...
                          <div className="space-y-2">
                            {compResult.required_approvals.length > 0 ? (
                              compResult.required_approvals.map((a, i) => (
                                <motion.div
                                  initial={{ opacity: 0, x: -10 }}
                                  animate={{ opacity: 1, x: 0 }}
                              ...
                              <div className="text-xs font-medium text-zinc-400 italic bg-white/40 p-4 rounded-xl text-center">
                                لا توجد اشتراطات فنية خاصة لهذا الصنف
                              </div>
                            )}
                          </div>
                        </motion.div>
                            ...
                            <div className="space-y-2">
                              ...
                              <div className="h-1 bg-white/10 rounded-full overflow-hidden">
                                <motion.div
                                  initial={{ width: 0 }}
                                  animate={{
                                    width: compResult.risk_flags.length > 0 ? "40%" : "100%",
                                  }}
                                  className={cn(
                            ...
                            <div className="space-y-2">
                              ...
                              {compResult.risk_flags.length === 0 && (
                                <p className="text-xs font-medium text-emerald-300 bg-emerald-500/10 p-3 rounded-lg border border-emerald-500/20 flex items-center gap-2">
                                  <ShieldCheck className="w-4 h-4" /> تم المسح: شحنة آمنة وقليلة
                                  المخاطر
                                </p>
                              )}
                            </div>
            ...
            >
              <div className="flex justify-between items-center bg-zinc-50 p-6 rounded-3xl border border-zinc-100 mb-6 group hover:border-zinc-200 transition-colors">
                <div>
                  ...
                  <p className="text-sm text-zinc-500 font-medium mt-2 max-w-lg leading-relaxed">
                    قم بإدارة قائمة المخلصين وارسل طلبات تحديث المستندات السريعة بنقرة واحدة لضمان
                    دقة العمليات وعدم التأخير في المنافذ.
                  </p>
                </div>
                <button
                  onClick={() => {
                    ...
                    setTimeout(
                      () => toast.success("تم إرسال طلب التحديث لجميع المخلصين بنجاح"),
                      1500
                    );
                  }}
              ...
              <div className="space-y-4">
                {[
                  {
                    name: "مؤسسة الدانة للتخليص",
                    license: "LIC-109283",
                    activeShipments: 12,
                    rating: 4.8,
                  },
                  {
                    name: "شركاء الإمداد الجمركي",
                    license: "LIC-993821",
                    activeShipments: 5,
                    rating: 4.5,
                  },
                  {
                    name: "الشركة الوطنية للعبور",
                    license: "LIC-112003",
                    activeShipments: 1,
                    rating: 4.0,
                  },
                  ...
                  <div
                    key={i}
                    className="flex flex-col sm:flex-row sm:items-center justify-between p-6 bg-zinc-50/50 rounded-2xl border border-zinc-100/80 hover:bg-white hover:border-zinc-200 hover:shadow-xl hover:shadow-zinc-900/5 transition-all group"
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-3 mt-1.5">
                          <span className="text-[10px] font-black tracking-widest text-zinc-400 uppercase bg-zinc-100 px-2 py-0.5 rounded">
                            {broker.license}
                          </span>
                          <span className="text-xs font-bold text-zinc-500">
                            تقييم: <span className="text-amber-500">★ {broker.rating}</span>
                          </span>
                        </div>
                      </div>
                    </div>
                    <div className="flex items-center gap-4 mt-4 sm:mt-0">
                      <div className="text-center sm:text-right">
                        ...
                        <p className="text-xl font-bold tracking-tighter text-zinc-900 mt-0.5">
                          {broker.activeShipments}
                        </p>
                      </div>
                      <div className="w-px h-8 bg-zinc-200" />
                      <button
                        onClick={() => toast.success(`تم إرسال تنبيه للمخلص: ${broker.name}`)}
                        className="w-10 h-10 rounded-xl bg-emerald-50 text-emerald-600 flex items-center justify-center hover:bg-emerald-100 transition-colors tooltip"
                        title="واتساب المخلص"
                      >
        ...
        <div className="space-y-8">
                  ...
                  >
                    ...
                    <div className="mr-3">
                      <div className="flex justify-between items-center mb-1">
                        <p className="text-[10px] font-black text-zinc-400 font-mono tracking-widest">
                          {new Date(event.createdAt).toLocaleTimeString("ar-SA")}
                        </p>
                        <span className="text-[9px] px-1.5 py-0.5 bg-zinc-100 text-zinc-500 rounded uppercase font-black tracking-tighter">
                          {event.type}
                        </span>
                      </div>
              ...
              {shipments.every((s) => !s.events || s.events.length === 0) && (
                <div className="py-12 text-center space-y-3">
                  ...
                  <p className="text-[10px] font-black text-zinc-300 uppercase tracking-widest italic">
                    System Standby: Awaiting Events
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-xl rounded-[1.5rem] p-5 h-[350px] flex flex-col relative z-10 border border-white/10">
              <div className="flex-1 overflow-y-auto space-y-4 mb-5 pr-2 -mr-2 scrollbar-hide">
                <div className="bg-white/10 p-4 rounded-2xl rounded-tr-none text-[11px] font-bold text-emerald-100/80 shadow-sm border border-white/5 self-start leading-relaxed">
                  مرحباً بك! أنا مساعد مدارج الذكي. يمكنني مساعدتك في فهم إجراءات الجمارك السعودية
                  بناءً على شحنتك المحددة.
                </div>
                {aiThread.map((msg, i) => (
                  <motion.div
              ...
              <div className="relative">
                ...
                <button
                  onClick={askAi}
                  className="absolute left-2.5 top-1/2 -translate-y-1/2 p-2 bg-primary text-zinc-900 rounded-lg hover:scale-110 active:scale-90 transition-all shadow-lg shadow-primary/20"
                >
          ...
          >
            ...
            <p className="text-zinc-400 text-[10px] font-black uppercase tracking-[0.2em] mb-8 relative z-10">
              Q2 | 2024 PERFORMANCE REPORT
            </p>
                ...
                <AnimatePresence mode="wait">
                    ...
                    >
                      <div className="space-y-3">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setNewShipment({ ...newShipment, supplierName: e.target.value })
                          }
                        />
                      </div>
                      <div className="space-y-3">
                        ...
                        <textarea
                          ...
                          onChange={(e) =>
                            setNewShipment({ ...newShipment, productDescription: e.target.value })
                          }
                        />
                      </div>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-3">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setNewShipment({ ...newShipment, alias: e.target.value })
                            }
                          />
                        </div>
                        <div className="space-y-3">
                          <label className="text-[10px] font-black text-zinc-400 uppercase tracking-widest px-1">
                            ارتباط بعميل CRM (اختياري)
                          </label>
                          <select
                            className="w-full px-6 py-5 rounded-2xl bg-zinc-50 border-2 border-transparent focus:border-primary/20 focus:bg-white focus:ring-0 text-zinc-900 font-bold transition-all"
                            value={newShipment.clientId}
                            onChange={(e) =>
                              setNewShipment({ ...newShipment, clientId: e.target.value })
                            }
                          >
                  ...
                  {formStep === 2 && (
                    ...
                    >
                      <div className="grid grid-cols-2 gap-6">
                        <div className="space-y-3">
                          ...
                          <select
                            ...
                            onChange={(e) =>
                              setNewShipment({ ...newShipment, countryOfOrigin: e.target.value })
                            }
                          >
                            {countries.map((c) => (
                        ...
                        <div className="space-y-3">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setNewShipment({ ...newShipment, originPort: e.target.value })
                            }
                          />
                        </div>
                      </div>
                      <div className="space-y-3">
                        <label className="text-[10px] font-black text-zinc-400 uppercase tracking-widest px-1">
                          ميناء الوصول (Kingdom of Saudi Arabia)
                        </label>
                        <input
                          type="text"
                          className="w-full px-6 py-5 rounded-2xl bg-zinc-50 border-2 border-transparent focus:border-primary/20 focus:bg-white focus:ring-0 text-zinc-900 font-bold"
                          ...
                          onChange={(e) =>
                            setNewShipment({ ...newShipment, destinationPort: e.target.value })
                          }
                        />
                      </div>
                      <div className="space-y-3">
                    ...
                    >
                      <div className="bg-zinc-900 text-white p-8 rounded-[2rem] space-y-6 relative overflow-hidden">
                        ...
                        <div className="space-y-3 relative z-10">
                          ...
                          <select
                            ...
                            onChange={(e) =>
                              setNewShipment({ ...newShipment, brokerId: e.target.value })
                            }
                          >
                            <option value="" className="text-zinc-900">
                              نظام المخلص الآلي (نظام مدارج)
                            </option>
                            {brokers.map((b) => (
                      ...
                      <div className="p-6 bg-emerald-50 rounded-2xl border border-emerald-100 flex items-center gap-4">
                        ...
                        <p className="text-xs font-bold text-emerald-800 leading-relaxed">
                          بإتمامك لهذه الخطوة، سيقوم محرك الامتثال الذكي لدينا بربط شحنتك بمتطلبات
                          هيئة الزكاة والضريبة والجمارك (ZATCA) بشكل تلقائي.
                        </p>
                      </div>
                    </motion.div>
                  )}
