      ...
      <main className="pt-32 pb-24">
        <div className="container mx-auto px-6 max-w-4xl text-center">
          ...
          >
            ...
            <p className="text-xl text-zinc-500 font-medium">اخترت الطريقة الأسهل للوصول لفريقنا. نحن جاهزون للرد على استفساراتك فوراً.</p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
               ...
               <p className="text-zinc-400 text-sm font-medium relative z-10 mb-6">الطريقة الأسرع للوصول إلينا</p>
               <span className="text-emerald-400 font-bold relative z-10 inline-flex items-center gap-2">ابدأ المحادثة &larr;</span>
            </motion.a>
            ...
            >
               ...
               <p className="text-zinc-500 text-sm font-medium mb-6">اكتشف لوحة التحكم كاملة مع خبير</p>
               <button className="text-blue-500 font-bold inline-flex items-center gap-2">تصفح التقويم &larr;</button>
            </motion.div>
            ...
            >
               ...
               <p className="text-zinc-500 text-sm font-medium mb-6">احصل على إجابات سريعة وفورية لأي سؤال</p>
               <button className="text-primary font-bold inline-flex items-center gap-2">تحدث الآن &larr;</button>
            </motion.div>
          </div>
        </div>
      </main>
