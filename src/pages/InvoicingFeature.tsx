      ...
      <nav className="fixed top-0 left-0 w-full z-50 px-6 py-4 transition-all duration-300 backdrop-blur-md bg-zinc-950/90 border-b border-white/10 text-white">
        <div className="container mx-auto max-w-7xl flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link
              to="/app"
              className="px-4 py-2 bg-white text-zinc-950 text-sm font-black rounded-lg hover:bg-zinc-100 transition-all shadow-md shadow-white/10"
            >
              جرب منشئ الفواتير مجاناً
            </Link>
          </div>
        </div>
      </nav>
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-black text-zinc-900 tracking-tight leading-tight mb-6">
              أنشئ فاتورة ضريبية في{" "}
              <span className="bg-primary text-white px-4 py-2 rounded-2xl rotate-2 inline-block">
                30 ثانية
              </span>
            </h1>
            <p className="text-xl text-zinc-500 font-medium max-w-2xl mx-auto">
              من صفقات الواتساب إلى فواتير ZATCA معتمدة وروابط دفع فورية. أسرع دورة مبيعات يمكن أن
              تتخيلها.
            </p>
            ...
            <div className="mt-10">
              <Link
                to="/app"
                className="inline-flex items-center gap-3 px-8 py-4 bg-zinc-900 text-white rounded-2xl font-black text-lg hover:bg-zinc-800 hover:scale-105 active:scale-95 transition-all shadow-xl"
              >
            ...
            <div className="relative z-10 grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-zinc-400 font-medium text-lg leading-relaxed mb-8">
                  لا داعي لإدخال أسماء العملاء أو الأرقام الضريبية في كل مرة يدوياً. النظام يسحب
                  بيانات العميل، يحسب ضريبة القيمة المضافة، ويُصدر رابط الدفع آلياً (Tap/Stripe).
                </p>
                <ul className="space-y-4 font-bold text-zinc-300">
                  <li className="flex gap-3">
                    <CheckCircle2 className="text-primary w-6 h-6" /> امتثال تام 100% (المرحلة
                    الثانية ZATCA)
                  </li>
                  <li className="flex gap-3">
                    <CheckCircle2 className="text-primary w-6 h-6" /> قوالب احترافية تعكس هويتك
                    البصرية
                  </li>
                  <li className="flex gap-3">
                    <CheckCircle2 className="text-primary w-6 h-6" /> روابط سداد ذكية Mada, Visa,
                    ApplePay
                  </li>
                </ul>
              </div>
              <div className="bg-zinc-950 p-6 rounded-3xl border border-white/10 shadow-2xl relative">
                <div className="flex justify-between items-center border-b border-white/10 pb-4 mb-4">
                  ...
                  <div className="bg-emerald-500/20 text-emerald-400 text-xs px-2 py-1 rounded font-bold">
                    بانتظار الدفع
                  </div>
                </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white p-8 rounded-[2rem] border border-zinc-200">
              ...
              <p className="text-zinc-500 text-sm font-medium">
                لو كان لديك خدمة تستخدمها باستمرار، حفظها في دليل المنتجات لإنزاله في الفواتير بضغطة
                زر واحدة.
              </p>
            </div>
            <div className="bg-white p-8 rounded-[2rem] border border-zinc-200">
              ...
              <p className="text-zinc-500 text-sm font-medium">
                عندما يدفع العميل عبر الرابط، تتغير حالة الفاتورة تلقائياً إلى "مدفوعة" وتحدث
                إيرادات الشركة.
              </p>
            </div>
            <div className="bg-white p-8 rounded-[2rem] border border-zinc-200">
              ...
              <p className="text-zinc-500 text-sm font-medium">
                تحويل عروض الأسعار إلى فواتير ضريبية نهائية بضغطة واحدة، دون إعادة إدخال البيانات
                المكررة.
              </p>
            </div>
          </div>
