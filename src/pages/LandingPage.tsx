...
import {
  MessageSquare, FileText, CreditCard, PieChart, Users, Zap, Shield, ArrowLeft,
  ChevronLeft, Sparkles, Building2, CheckCircle2, Bot, Play, Pause, ChevronRight,
...
const HeroSection = () => {
  ...
  const rx = useSpring(useTransform(() => mouseY * -20), { stiffness: 150, damping: 20 });
  const ry = useSpring(useTransform(() => mouseX * 20), { stiffness: 150, damping: 20 });
  const translateZ = useSpring(useTransform(() => Math.abs(mouseX) * -50), { stiffness: 150, damping: 20 });

  return (
    <div ref={containerRef} onMouseMove={handleMouseMove} className="relative min-h-screen flex items-center justify-center overflow-hidden bg-zinc-950 text-white selection:bg-primary/30 text-center perspective-[2000px]" dir="rtl">
      {/* Background Ambience */}
      <motion.div style={{ y, opacity }} className="absolute inset-0 z-0">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-primary/20 blur-[120px] rounded-full point-events-none animate-pulse" style={{ animationDuration: "8s" }} />
        <div className="absolute bottom-1/4 right-1/4 w-[600px] h-[300px] bg-emerald-500/10 blur-[100px] rounded-full point-events-none animate-pulse" style={{ animationDuration: "10s" }} />
      </motion.div>
              ...
              <div className="px-5 py-4 bg-zinc-900/80 border-b border-white/5 flex gap-3 items-center backdrop-blur-md relative z-20">
                 ...
                 <div className="flex-1 flex justify-center">
                    <div className="w-96 h-8 bg-black/40 rounded-lg border border-white/10 flex items-center px-4 gap-2 shadow-inner hover:bg-black/60 transition-colors">
                       ...
                       <span className="text-[11px] text-zinc-400 font-mono tracking-widest uppercase mt-0.5">app.mudarij.com</span>
                    </div>
                 </div>
                       ...
                       <div className="space-y-1 block">
                          {[
                            ...
                            { icon: Shield, label: 'الامتثال', active: false },
                             ...
                             <div key={i} className={cn("flex items-center gap-3 px-4 py-3 rounded-lg transition-all cursor-pointer", item.active ? "bg-primary text-white shadow-md shadow-primary/10" : "text-zinc-500 hover:bg-zinc-100 hover:text-zinc-900")}>
                    ...
                    <div className="col-span-2 bg-white rounded-3xl border border-zinc-100 p-8 flex flex-col relative shadow-sm">
                       <div className="flex justify-between items-start mb-6">
                          <div>
                             ...
                             <p className="text-zinc-500 text-xs mt-1 font-medium">أداء المبيعات لآخر 6 أشهر</p>
                          </div>
                       ...
                       <div className="flex-1 flex items-end pt-4 relative z-10 w-full mb-2 border-b border-zinc-100">
                          <svg className="w-full h-[150px]" preserveAspectRatio="none" viewBox="0 0 100 100">
                             <defs>
                             ...
                             <path d="M0,100 L0,50 C20,40 40,80 60,30 C80,10 90,40 100,20 L100,100 Z" fill="url(#chartGradient)" />
                             <path d="M0,50 C20,40 40,80 60,30 C80,10 90,40 100,20" fill="none" stroke="#10b981" strokeWidth="3" vectorEffect="non-scaling-stroke" />
                          </svg>
                       </div>
                    ...
                    <div className="flex flex-col gap-6 relative z-10">
                       ...
                       <div className="flex-1 bg-white rounded-3xl border border-zinc-100 p-6 flex flex-col relative shadow-sm">
                          ...
                          <div className="space-y-4">
                             {[
                               { action: "فاتورة لشركة ألفا", module: "INVOICE", time: "10:30 م", color: "text-emerald-500", bg: "bg-emerald-50", border: "border-emerald-100", icon: FileText },
                               { action: "تسجيل عميل جديد", module: "CRM", time: "09:15 ص", color: "text-blue-500", bg: "bg-blue-50", border: "border-blue-100", icon: Users },
                               { action: "تقرير ضريبي", module: "INVOICE", time: "08:00 ص", color: "text-primary", bg: "bg-primary/10", border: "border-primary/20", icon: FileText }
                             ].map((log, i) => (
                               <div key={i} className="flex gap-4 items-start pb-4 border-b border-zinc-50 last:border-0 last:pb-0">
                                 <div className={cn("w-10 h-10 rounded-xl flex-shrink-0 flex items-center justify-center border", log.bg, log.color, log.border)}>
                                    <log.icon className="w-4 h-4" />
                                 </div>
                                 <div>
                                   <p className="text-sm font-bold text-zinc-900">{log.action}</p>
                                   <p className="text-[10px] text-zinc-400 mt-0.5 font-medium">{log.time} • مسؤول النظام</p>
                                 </div>
                               </div>
                             ))}
                          </div>
         ...
         <div className="container mx-auto px-6 max-w-7xl relative z-10">
            ...
            >
               <h2 className="text-4xl md:text-6xl font-black text-zinc-900 tracking-tight leading-tight">
                  العمل التقليدي <span className="text-rose-500 line-through decoration-4">فوضوي</span> ومدمر للوقت
               </h2>
            ...
            >
               {[
                  ...
                  >
                     ...
                     <div className={cn("w-14 h-14 rounded-2xl flex items-center justify-center mb-6 relative z-10", item.bg, item.color)}>
         ...
         <div className="container mx-auto px-6 max-w-7xl">
            ...
            >
               <h2 className="text-4xl md:text-5xl font-black text-zinc-900 tracking-tight leading-tight max-w-3xl mx-auto">
                  ليس مجرد نظام، بل هو <span className="text-primary tracking-tighter">دماغ إلكتروني</span> لإدارة شركتك بالكامل.
               </h2>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[300px] perspective-[1500px]">
               ...
               >
                  ...
                  <div className="relative z-10 w-full h-full flex flex-col justify-between">
                     ...
                     <div>
                        <h3 className="text-3xl font-black mb-2 relative z-10">إدارة علاقات العملاء (CRM)</h3>
                        <p className="text-zinc-400 font-medium text-lg relative z-10">من العميل المحتمل وحتى إغلاق الصفقة وتوليد الفاتورة.</p>
                     </div>
                  </div>
               </motion.div>
               ...
               >
                  ...
                  <div className="relative z-10 w-full h-full flex flex-col justify-between">
                     ...
                     <div>
                        <h3 className="text-2xl font-black text-zinc-900 mb-2 relative z-10">فواتير وقوائم ضريبية</h3>
                        <p className="text-zinc-500 font-medium text-sm relative z-10">متوافقة بنسبة 100٪ مع هيئة الزكاة والضريبة ودعم الفوترة الإلكترونية.</p>
                     </div>
                  </div>
               </motion.div>
                  ...
                  <div className="relative z-10 w-full h-full flex flex-col justify-between">
                     ...
                     <div>
                        <h3 className="text-3xl font-black mb-2 flex flex-wrap items-center gap-3 relative z-10">
                           بيئة الامتثال <span className="bg-rose-500/20 text-rose-300 text-xs px-2 py-1 rounded-full uppercase tracking-widest font-black shrink-0">FWC-OS</span>
                        </h3>
                        <p className="text-zinc-400 font-medium text-lg relative z-10">أتمتة ذكية لضمان التوافق مع WPS وتجديد الإقامات دون غرامات وبلا مجهود.</p>
                     </div>
                  </div>
               </motion.div>
            </div>
      ...
      <section className="py-32 bg-zinc-950 text-white relative overflow-hidden" dir="rtl">
         ...
         <div className="container mx-auto px-6 max-w-7xl relative z-10">
            <div className="text-center mb-24">
               <h2 className="text-4xl md:text-5xl font-black tracking-tight mb-4">من المحادثة إلى الأرباح، في ثوانٍ.</h2>
            ...
            >
               ...
               >
                  ...
                  <div className="space-y-3">
                     <div className="bg-zinc-800 p-3 rounded-xl rounded-tr-none text-sm w-11/12 ml-auto text-zinc-300">السلام عليكم، أريد طلب الخدمة الأساسية بـ 500 ريال.</div>
                     <div className="bg-emerald-500/20 text-emerald-200 border border-emerald-500/30 p-3 rounded-xl rounded-tl-none text-sm w-11/12">تم، جاري تجهيز الفاتورة التلقائية لك.</div>
                  </div>
               </motion.div>
               ...
               >
                  ...
                  <div className="bg-zinc-900 border border-white/5 p-4 rounded-xl flex flex-col gap-2">
                     ...
                     <button className="w-full mt-2 py-2 bg-primary/20 text-primary hover:bg-primary/30 rounded-lg text-xs font-bold transition-all">رابط الدفع (Stripe/Tap)</button>
                  </div>
               </motion.div>
...
const SocialProofSection = () => {
   return (
      <section className="py-24 bg-zinc-50 border-y border-zinc-200 overflow-hidden relative" dir="rtl">
         ...
         <div className="container mx-auto px-6 text-center max-w-7xl relative z-0">
            <h3 className="text-zinc-500 font-black tracking-widest uppercase text-xs mb-12">الخيار الأول لأكثر من 5,000 شركة ورائد أعمال في المملكة والخليج</h3>
            ...
            >
               ...
               {[1, 2].map((group) => (
                  <React.Fragment key={group}>
                     <div className="flex items-center gap-3 font-black text-2xl text-zinc-800"><Building2 className="w-8 h-8 text-primary"/> مجموعة الرائدة</div>
                     <div className="flex items-center gap-3 font-black text-2xl text-zinc-800"><Globe className="w-8 h-8 text-emerald-500"/> خدمات ألفا</div>
                     <div className="flex items-center gap-3 font-black text-2xl text-zinc-800"><Zap className="w-8 h-8 text-blue-500"/> تقنية الغد</div>
                     <div className="flex items-center gap-3 font-black text-2xl text-zinc-800"><Shield className="w-8 h-8 text-rose-500"/> درع الأمن</div>
                  </React.Fragment>
               ))}
            </motion.div>
         </div>
      ...
      <section className="py-32 bg-white perspective-[2000px] overflow-hidden" dir="rtl">
         <div className="container mx-auto px-6 max-w-7xl">
            <motion.div 
               ...
               className="text-center mb-20"
            >
               <h2 className="text-4xl md:text-5xl font-black text-zinc-900 tracking-tight">استثمار بسيط. نمو هائل.</h2>
            </motion.div>
            ...
            <div className="flex flex-col lg:flex-row justify-center gap-8 items-center lg:items-stretch perspective-[1500px]">
               ...
               >
                  ...
                  <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-primary text-white font-black px-4 py-1.5 rounded-full text-xs tracking-widest uppercase shadow-lg shadow-primary/30">الأكثر طلباً</div>
...
const FinalCTA = () => {
   return (
      <section className="py-32 relative overflow-hidden bg-zinc-950 text-white text-center" dir="rtl">
         <div className="absolute inset-0 bg-primary/10 blur-[100px] rounded-full point-events-none" />
         <div className="container mx-auto px-6 max-w-4xl relative z-10">
            <h2 className="text-5xl md:text-7xl font-black tracking-tight mb-8">ابدأ في تحويل عملك اليوم.</h2>
            <p className="text-xl text-zinc-400 mb-12 font-medium">انضم لآلاف الشركات الخليجية التي تعتمد على مدارج كنظام تشغيل رقمي موحد وموثوق.</p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
               <Link to="/app" className="px-10 py-5 bg-white text-zinc-950 rounded-2xl font-black hover:scale-105 active:scale-95 transition-all text-lg shadow-[0_0_30px_rgba(255,255,255,0.2)]">ابدأ تجربتك المجانية</Link>
