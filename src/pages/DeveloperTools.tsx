    ...
    <div className="space-y-8">
      <div className="mb-8">
        ...
        <p className="text-zinc-500 mt-2 font-medium">
          اربط أنظمتك الحالية، مثل المنصات المحلية كـ "سلة" و"زد"، مع مدارج OS بسهولة.
        </p>
      </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-[10px] text-zinc-400 mt-1">
                يُستخدم للتشغيل الفعلي. لا تشارك هذا المفتاح أبداً.
              </p>
            </div>
          </div>
        </motion.div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-3 border border-zinc-100 rounded-xl bg-zinc-50">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-white rounded-lg shadow-sm border border-zinc-100 flex items-center justify-center font-bold text-emerald-500">
                  سلة
                </div>
                <div>
              ...
              <button className="text-xs font-bold bg-white border border-zinc-200 px-3 py-1.5 rounded-lg shadow-sm hover:bg-zinc-50">
                توصيل
              </button>
            </div>
            ...
            <div className="flex items-center justify-between p-3 border border-zinc-100 rounded-xl bg-zinc-50">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-white rounded-lg shadow-sm border border-zinc-100 flex items-center justify-center font-bold text-purple-500">
                  زد
                </div>
                <div>
              ...
              <button
                className="text-xs font-bold bg-white text-zinc-400 border border-zinc-200 px-3 py-1.5 rounded-lg shadow-sm"
                disabled
              >
                متصل
              </button>
      ...
      >
        ...
        <div className="p-6">
          <pre
            className="text-sm font-mono text-emerald-400 whitespace-pre-wrap overflow-x-auto"
            dir="ltr"
          >
