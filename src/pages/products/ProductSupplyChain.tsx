...
export default function ProductSupplyChain() {
  ...
  useEffect(() => {
    ...
    metaDesc.setAttribute(
      "content",
      "لوحة تحكم ذكية لتتبع الحاويات والشحنات الجمركية وربطها المباشر مع منصة فسح لإدارة المخلصين وحساب التكلفة الفعلية الواصلة للمخازن بدقة."
    );
  }, []);
        ...
        <div className="container mx-auto px-6 max-w-7xl relative z-10 text-center">
          ...
          >
            ...
            <span className="text-sm font-semibold text-emerald-200">
              سلاسل الإمداد وتتبع الشحنات الجمركية والمخازن
            </span>
          </motion.div>
          ...
          >
            تتبع جمركي لحظي. <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-l from-white via-emerald-400 to-teal-300">
              من الموانئ حتى مستودعاتك بالكامل.
            </span>
          </motion.h1>
          ...
          >
            أول نظام متكامل يربط المخلصين الجمركيين وتحديثات بوابة فسح، تتبع الشحنات والحاويات
            البحرية والجوية والبرية، حساب التكلفة الكلية للمنتج المستورد (Landed Cost)، والمزامنة
            اللحظية مع المخزون والموردين.
          </motion.p>
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black mb-4">
              أداة حساب تكلفة المنتج المستورد الإجمالية (Landed Cost)
            </h2>
            <p className="text-zinc-400 text-lg max-w-2xl mx-auto">
              احسب تكلفتك الفعلية الشاملة للجمارك والنقل والرسوم الإدارية لتقييم هوامش الربح.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="bg-zinc-950/80 border border-white/10 p-8 rounded-[2.5rem] shadow-2xl relative overflow-hidden backdrop-blur-3xl space-y-6">
              ...
              <div className="space-y-4 text-xs font-bold">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-zinc-400 mb-2 font-black uppercase tracking-wider">
                      سعر المنتج الأصلي من المورد (ر.س)
                    </label>
                    <input
                      type="number"
                      value={productCost}
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div>
                    <label className="block text-zinc-400 mb-2 font-black uppercase tracking-wider">
                      تكلفة الشحن والنقل الداخلي (ر.س)
                    </label>
                    <input
                      type="number"
                      value={transportFee}
            ...
            <div className="space-y-8">
              <div className="p-8 bg-zinc-900/50 rounded-[2.5rem] border border-white/5 relative overflow-hidden flex flex-col justify-between">
                <div>
                  <span className="text-zinc-500 text-xs font-black uppercase tracking-wider block mb-2">
                    تكلفة المنتج النهائي الواصل للمخزن (Landed Cost Per Item)
                  </span>
                  <h3 className="text-5xl md:text-6xl font-black text-emerald-400 tracking-tight">
                    {landedCostPerItem.toFixed(1)}{" "}
                    <span className="text-2xl text-white">ر.س / قطعة</span>
                  </h3>
                  <p className="text-zinc-400 text-sm font-bold mt-4 leading-relaxed">
                    هذا هو الرقم الحقيقي الذي يجب عليك تسعير منتجك ومنافسة السوق بناءً عليه. استخدام
                    مدارج يمنع تماماً الخسائر الناتجة عن إغفال مصاريف الشحن أو رسوم التخليص والفسح
                    الجمركي.
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-4 bg-zinc-900/40 rounded-2xl border border-white/5">
                  ...
                  <p className="text-zinc-400 text-xs font-medium leading-relaxed">
                    أول لوحة تحكم تمنحك إشعارات وتحديثات جمركية لحظية للبضائع القادمة عبر الموانئ
                    السعودية.
                  </p>
                </div>
                ...
                <div className="p-4 bg-zinc-900/40 rounded-2xl border border-white/5">
                  ...
                  <p className="text-zinc-400 text-xs font-medium leading-relaxed">
                    بمجرد فسح الحاوية ودخول البضاعة للمستودع في الرياض، يتم تحديث الأرصدة تلقائياً
                    في المخزن.
                  </p>
                </div>
              </div>
      ...
      >
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-20">
            <h2 className="text-3xl md:text-5xl font-black mb-4">
              تحكّم مطلق بسلاسل الإمداد والتوريد
            </h2>
            <p className="text-zinc-400 text-lg max-w-2xl mx-auto">
              أتمتة ذكية تفصل بين مرحلة التصنيع بالخارج ووصول الحاويات لشركة النقل المحلية.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 rounded-[2rem] border border-white/5 bg-zinc-900/40 relative overflow-hidden group hover:border-white/10 transition-colors">
              ...
              <p className="text-zinc-400 text-sm font-medium leading-relaxed">
                أنشئ قاعدة بيانات بجميع المخلصين المعتمدين لديك في الموانئ السعودية (ميناء الملك عبد
                العزيز، ميناء جدة الإسلامي، إلخ) وشارك المستندات والملفات والمدفوعات المالية معهم
                تلقائياً.
              </p>
            </div>
            ...
            <div className="p-8 rounded-[2rem] border border-white/5 bg-zinc-900/40 relative overflow-hidden group hover:border-white/10 transition-colors">
              ...
              <p className="text-zinc-400 text-sm font-medium leading-relaxed">
                اربط حركة الشحن ومستندات بوالص الشحن الجمركي مباشرةً مع حسابات الموردين في الخارج
                وتسهيل الدفعات بالدولار أو العملات الأجنبية مع مراجعة هوامش التحويل المصرفي.
              </p>
            </div>
            ...
            <div className="p-8 rounded-[2rem] border border-white/5 bg-zinc-900/40 relative overflow-hidden group hover:border-white/10 transition-colors">
              ...
              <h3 className="text-xl font-black text-white mb-3">
                رؤية لوجستية كاملة للرئيس التنفيذي
              </h3>
              <p className="text-zinc-400 text-sm font-medium leading-relaxed">
                لوحات تحكم ومؤشرات تتبع الشحنات الجارية والمتوقع وصولها تتيح للمجلس التنفيذي تخطيط
                الحملات التسويقية والبيعية وتحديد الموازنات بدقة وثقة عالية.
              </p>
            </div>
          </div>
        </div>
      ...
      >
        <div className="container mx-auto px-6 max-w-5xl text-center relative z-10">
          ...
          <p className="text-zinc-400 text-lg md:text-xl font-medium max-w-2xl mx-auto mb-10 leading-relaxed">
            انضم إلى شركات الاستيراد والتوزيع السعودية الرائدة التي تبني أعمالها اللوجستية بالكامل
            عبر مدارج OS.
          </p>
