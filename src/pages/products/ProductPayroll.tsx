...
export default function ProductPayroll() {
  ...
  let nitaqatDescription = "أنت معرض لإيقاف الخدمات الجمركية وإصدار التأشيرات الفورية بسبب انخفاض نسبة التوطين.";

  if (saudizationPct >= 35) {
    nitaqatLabel = "أخضر مرتفع";
    nitaqatColorClass = "text-emerald-400 bg-emerald-500/10 border-emerald-500/20";
    nitaqatDescription = "شركتك في أمان تام! مؤهلة للاستقدام الفوري للموظفين، وتأشيرات فورية عبر قوى وميزات حماية الأجور.";
  } else if (saudizationPct >= 20) {
    nitaqatLabel = "أخضر منخفض";
    nitaqatColorClass = "text-green-400 bg-green-500/10 border-green-500/20";
    nitaqatDescription = "في النطاق الآمن. يمكنك نقل الكفالات والتجديد، ويُنصح بزيادة التوطين لرفع التقييم العام.";
  } else if (saudizationPct > 0) {
    nitaqatLabel = "أصفر";
    nitaqatColorClass = "text-amber-400 bg-amber-500/10 border-amber-500/20";
    nitaqatDescription = "نطاق حرج. لا يمكنك إصدار تأشيرات عمل جديدة ويتم تقييد بعض الخدمات تدريجياً.";
  }
  ...
  useEffect(() => {
    ...
    metaDesc.setAttribute('content', 'إدارة الرواتب وشؤون الموظفين بامتثال تام لوزارة الموارد البشرية ومنصات قوى ومدد. حساب التأمينات والبدلات وإصدار ملفات حماية الأجور بضغطة زر.');
  }, []);
      ...
      <section className="relative pt-44 pb-24 md:pt-56 md:pb-36 overflow-hidden">
        ...
        <div className="container mx-auto px-6 max-w-7xl relative z-10 text-center">
          ...
          >
            ...
            <span className="text-sm font-semibold text-rose-200">مسير الرواتب المعتمد وحماية الأجور (WPS)</span>
          </motion.div>
          ...
          >
            حساب فوري للبدلات والخصومات والتأمينات الاجتماعية، إصدار ملفات حماية الأجور (WPS) المتوافقة مع البنوك، وحساب مكافأة نهاية الخدمة، مع مراقبة نطاقات التوطين لحظياً.
          </motion.p>
          ...
          >
            <Link to="/app/payroll" className="px-8 py-4 bg-primary text-white font-black rounded-2xl text-lg hover:scale-105 transition-all shadow-lg shadow-primary/20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="bg-zinc-950/80 border border-white/10 p-8 rounded-[2.5rem] shadow-2xl relative overflow-hidden backdrop-blur-3xl space-y-6">
              ...
              <div className="flex justify-between items-center border-b border-white/5 pb-4">
                ...
                <span className="text-xs bg-rose-500/10 text-rose-400 px-2 py-0.5 rounded-lg font-bold">تفاعلي</span>
              </div>

              <div className="grid grid-cols-2 gap-6">
                <div>
                  <label className="block text-xs font-black text-zinc-400 mb-2 uppercase tracking-wide">عدد الموظفين السعوديين</label>
                ...
                <div>
                  <label className="block text-xs font-black text-zinc-400 mb-2 uppercase tracking-wide">عدد الموظفين الوافدين</label>
                  <div className="flex items-center gap-3">
                    <button 
              ...
              <div className="p-6 bg-zinc-900/50 rounded-2xl border border-white/5 space-y-4">
                <div className="flex justify-between items-center text-sm font-bold">
                  ...
                  <span className="text-rose-400 text-lg font-black">{saudizationPct.toFixed(1)}٪</span>
                </div>

                <div className="flex gap-1.5 h-2.5 rounded-full overflow-hidden bg-zinc-800">
                  <div style={{ width: `${saudizationPct}%` }} className="bg-emerald-500 h-full rounded-full transition-all" />
                  <div style={{ width: `${100 - saudizationPct}%` }} className="bg-zinc-700 h-full rounded-full transition-all" />
                </div>

                <div className="pt-3 border-t border-white/5 flex gap-4 items-start">
                  <span className={cn("px-3 py-1 rounded-xl text-xs font-black border uppercase tracking-wider shrink-0", nitaqatColorClass)}>
                    نطاق {nitaqatLabel}
                  </span>
            ...
            <div className="space-y-8">
              ...
              <h2 className="text-4xl md:text-5xl font-black tracking-tight leading-tight">
                أول نظام رواتب <span className="text-rose-400">يتطابق مع مدد وقوى تلقائياً</span> في المملكة.
              </h2>
              <p className="text-zinc-400 font-medium text-lg leading-relaxed">
                لا تضيع المزيد من الساعات شهرياً في تحضير ملفات الرواتب والأجور بصيغة WPS المتعبة. نظام مدارج يقوم بكل الرياضيات بالنيابة عنك: احتساب حصة التأمينات الاجتماعية (GOSI)، خصومات الغياب والتأخيرات المستوحاة من السجلات، والبدلات بجميع أنواعها، مع إخراج ملفات صرف رواتب مشفرة ومعتمدة تطابق تماماً متطلبات البنوك السعودية.
              </p>
      ...
      >
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-20">
            <h2 className="text-3xl md:text-5xl font-black mb-4">كافة احتياجات شؤون الموظفين في مكان واحد</h2>
            <p className="text-zinc-400 text-lg max-w-2xl mx-auto">تكامل مباشر يربط الحضور والغياب مع المحفظة المالية للمنشأة.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 rounded-[2rem] border border-white/5 bg-zinc-900/40 relative overflow-hidden group hover:border-white/10 transition-colors">
              ...
              <h3 className="text-xl font-black text-white mb-3">حماية الأجور والامتثال بنسبة 100%</h3>
              <p className="text-zinc-400 text-sm font-medium leading-relaxed">
                تجنب غرامات تأخر الرواتب ووضع منشأتك تحت طائلة القانون. يقوم النظام بإنشاء وتحديث مسيرات الأجور تلقائياً وتصدير ملفات WPS التي تقبلها جميع البنوك السعودية بضغطة زر.
              </p>
            </div>
            ...
            <div className="p-8 rounded-[2rem] border border-white/5 bg-zinc-900/40 relative overflow-hidden group hover:border-white/10 transition-colors">
              ...
              <h3 className="text-xl font-black text-white mb-3">إدارة الإجازات والتذاكر تلقائياً</h3>
              <p className="text-zinc-400 text-sm font-medium leading-relaxed">
                يتيح النظام للموظفين طلب الإجازات السنوية أو المرضية وعرض رصيد الإجازات المتبقي ومتابعة بدلات السفر وتذاكر الطيران، مع ترحيل تكلفتها تلقائياً للمسير المالي.
              </p>
            </div>
            ...
            <div className="p-8 rounded-[2rem] border border-white/5 bg-zinc-900/40 relative overflow-hidden group hover:border-white/10 transition-colors">
              ...
              <p className="text-zinc-400 text-sm font-medium leading-relaxed">
                نظّم عقود العمل الموثقة بنجاح عبر قوى، بطاقات الهويات الطبية والتأمينية، التوكيلات والتفويضات الإدارية لكل موظف بطريقة رقمية متطورة وسريعة الوصول للجميع.
              </p>
            </div>
          </div>
        </div>
