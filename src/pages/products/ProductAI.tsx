...
export default function ProductAI() {
  ...
  useEffect(() => {
    ...
    metaDesc.setAttribute('content', 'وكلاء ذكاء اصطناعي تفاعليين لإدارة أعمالك والتفاوض الذاتي مع العملاء والموردين باللغة العربية وصياغة ردود المحادثات التلقائية بكفاءة فائقة.');
  }, []);
  ...
  const startNegotiationSimulation = () => {
    ...
    setTimeout(() => {
      setNegotiationLogs(prev => [...prev, `[الوكيل]: العرض الحالي للعميل هو 7,000 ر.س. الميزانية المحددة: ${budget} ر.س.`]);
      setTimeout(() => {
      ...
      <section className="relative pt-44 pb-24 md:pt-56 md:pb-36 overflow-hidden">
        ...
        <div className="container mx-auto px-6 max-w-7xl relative z-10 text-center">
          ...
          >
            ...
            <span className="text-sm font-semibold text-cyan-200">مختبر أتمتة الأعمال والذكاء الاصطناعي (AI Lab)</span>
          </motion.div>
          ...
          >
            أول وكيل ذكي للشركات الخليجية يفهم عقود المقاولة، يتفاوض مع الموردين بناءً على ميزانياتك المستهدفة، يصيغ الردود التلقائية لرسائل واتساب، وينجز الإجراءات من شاشة واحدة بذكاء كامل.
          </motion.p>
          ...
          >
            <Link to="/app/smart-negotiations" className="px-8 py-4 bg-primary text-white font-black rounded-2xl text-lg hover:scale-105 transition-all shadow-lg shadow-primary/20">
      ...
      >
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black mb-4">محاكي وكيل التفاوض الذكي بالذكاء الاصطناعي</h2>
            <p className="text-zinc-400 text-lg max-w-2xl mx-auto">اضبط محاذاة أهداف المبيعات والميزانية، ودع وكيل مدارج الذكي يقوم بالصياغة وعرض الأرقام تلقائياً.</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="bg-zinc-950/80 border border-white/10 p-8 rounded-[2.5rem] shadow-2xl relative overflow-hidden backdrop-blur-3xl space-y-6">
              ...
              <div className="flex justify-between items-center border-b border-white/5 pb-4">
                ...
                <span className="text-xs bg-cyan-500/10 text-cyan-400 px-2 py-0.5 rounded-lg font-bold">تفاعلي بالكامل</span>
              </div>

              <div className="space-y-5 text-xs font-bold">
                <div>
                  <label className="block text-zinc-400 mb-2 uppercase tracking-wide">الميزانية المقترحة للمشروع / العرض (ر.س)</label>
                  <div className="flex items-center gap-4">
                    ...
                    />
                    <span className="text-white text-sm font-black shrink-0 w-24 text-left">{budget.toLocaleString()} ر.س</span>
                  </div>
                </div>

                <div>
                  <label className="block text-zinc-400 mb-2 uppercase tracking-wide">نسبة هامش الربح المستهدف (٪)</label>
                  <div className="flex items-center gap-4">
                    <input 
                      type="range" 
                      min="10" 
                      ...
                      className="w-full h-2 bg-zinc-800 rounded-lg appearance-none cursor-pointer accent-primary"
                    />
                    <span className="text-white text-sm font-black shrink-0 w-24 text-left">٪{targetProfit}</span>
                  </div>
                </div>
      ...
      >
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-20">
            <h2 className="text-3xl md:text-5xl font-black mb-4">أتمتة فائقة السرعة بامتثال كامل</h2>
            <p className="text-zinc-400 text-lg max-w-2xl mx-auto">تكاملات آمنة تحمي بيانات شركتك وسجل معاملاتك المالية بالكامل.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 rounded-[2rem] border border-white/5 bg-zinc-900/40 relative overflow-hidden group hover:border-white/10 transition-colors">
              ...
              <h3 className="text-xl font-black text-white mb-3">فهم عميق للهجة الخليجية المحلية</h3>
              <p className="text-zinc-400 text-sm font-medium leading-relaxed">
                تم صياغة وكلاء مدارج ليتفهموا تماماً اللهجة السعودية وأسلوب التفاوض الخليجي، مع مراعاة المصطلحات القانونية والإدارية المحلية الخاصة بسجلات قوى والتجارة والبلديات.
              </p>
            </div>
            ...
            <div className="p-8 rounded-[2rem] border border-white/5 bg-zinc-900/40 relative overflow-hidden group hover:border-white/10 transition-colors">
              ...
              <h3 className="text-xl font-black text-white mb-3">أمان تام وحماية للسرية والمستندات</h3>
              <p className="text-zinc-400 text-sm font-medium leading-relaxed">
                لا نستخدم بياناتك المالية أو وثائق عملائك لتدريب نماذج الذكاء الاصطناعي العامة. خصوصيتك هي الأولوية القصوى ونلتزم بأعلى معايير الهيئة الوطنية للأمن السيبراني.
              </p>
            </div>
            ...
            <div className="p-8 rounded-[2rem] border border-white/5 bg-zinc-900/40 relative overflow-hidden group hover:border-white/10 transition-colors">
              ...
              <p className="text-zinc-400 text-sm font-medium leading-relaxed">
                أنشئ تدفقات أتمتة معقدة بضغطة زر: "إذا استلمت بريداً بطلب تسعير، قم بصياغة عرض مبيعات CRM مؤقت، وتوليد مسودة عقد NDA جاهزة، وأرسل رسالة واتساب للعميل".
              </p>
            </div>
          </div>
        </div>
      ...
      >
        <div className="container mx-auto px-6 max-w-5xl text-center relative z-10">
          ...
          <p className="text-zinc-400 text-lg md:text-xl font-medium max-w-2xl mx-auto mb-10 leading-relaxed">
            وفّر الجهد، ضاعف المبيعات، ومكن موظفيك من التركيز على القيادة والإبداع الحقيقي مع أتمتة مدارج الذكية.
          </p>
