...
export default function ProductCRM() {
  const [pipelineState, setPipelineState] = useState([
    ...
    },
    {
      ...
      value: 120000,
      date: "يوم أمس",
      company: "تجزئة وأغذية",
    },
    {
      id: 3,
      name: "عقارات الماجدية",
      stage: "proposal",
      value: 350000,
      date: "قبل ٣ أيام",
      company: "تطوير عقاري",
  ...
  const [whatsappMock, setWhatsappMock] = useState([
    {
      id: 1,
      sender: "م. أحمد الغامدي",
      text: "أهلاً بك، نود الاستفسار عن تفاصيل عرض تسعير الفواتير والمخازن",
      time: "10:15 ص",
      parsed: false,
    },
    {
      id: 2,
      sender: "سارة الهاشم",
      text: "تمت الموافقة المبدئية على بنود العقد وسنرسل السجل التجاري قريباً",
      time: "09:30 ص",
      parsed: true,
    },
  ]);
  ...
  useEffect(() => {
    ...
    metaDesc.setAttribute(
      "content",
      "نظام إدارة علاقات العملاء (CRM) المتكامل من مدارج OS. تتبع مسار صفقاتك ومبيعاتك، أرشفة محادثات واتساب تلقائياً، وأغلق الصفقات بذكاء وسرعة."
    );
  }, []);
  ...
  const parseMessageToLead = useCallback(
    (id: number) => {
        ...
        <div className="container mx-auto px-6 max-w-7xl relative z-10 text-center">
          ...
          >
            ...
            <span className="text-sm font-semibold text-blue-200">
              نظام إدارة علاقات العملاء الذكي (CRM)
            </span>
          </motion.div>
          ...
          >
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-l from-white via-blue-400 to-cyan-300">
              أغلق صفقاتك بذكاء خارق.
            </span>
          </motion.h1>
          ...
          >
            مسارات مبيعات تفاعلية، ربط تلقائي ومباشر برقم واتساب الخاص بشركتك، وتوليد بطاقات العملاء
            الفورية بالذكاء الاصطناعي مع تحليلات ذكية ومقاييس حية.
          </motion.p>
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black mb-4">
              مسار مبيعات سلس مثل البريد الإلكتروني
            </h2>
            <p className="text-zinc-400 text-lg max-w-2xl mx-auto">
              تفاعل مع المحاكاة أدناه لتغيير حالات العملاء بالضغط على الأزرار.
            </p>
          </div>
                  ...
                  .map((item) => (
                    ...
                    >
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-[10px] bg-emerald-500/10 text-emerald-400 py-0.5 px-2 rounded-md font-bold">
                          عقد جاري
                        </span>
                      </div>
                    </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl font-black tracking-tight leading-tight">
                أول نظام مبيعات متكامل{" "}
                <span className="text-emerald-400">بخدمات واتساب السحابية</span> للشركات السعودية.
              </h2>
              <p className="text-zinc-400 font-medium text-lg leading-relaxed">
                معظم صفقاتك تجري على واتساب، لكنك تفقد السيطرة على البيانات. مدارج يحل هذه المشكلة
                جذرياً: يستقبل النظام رسائل العملاء، ويحللها بالذكاء الاصطناعي، ويقترح عليك تحويلها
                فوراً إلى صفقة CRM جديدة بضغطة زر، دون أي إدخال يدوي مجهد.
              </p>
                ...
                <div className="flex items-center gap-3 pb-6 border-b border-white/5 mb-6">
                  ...
                  <div>
                    <h4 className="text-sm font-black text-white">
                      مركز واردات الواتساب (المحاكاة)
                    </h4>
                    <p className="text-[10px] text-zinc-400 font-medium">
                      الرسائل الواردة غير المعالجة
                    </p>
                  </div>
                </div>
                    ...
                    <div
                      ...
                      className={cn(
                        ...
                        msg.parsed
                          ...
                          : "bg-zinc-900 border-emerald-500/30 shadow-md shadow-emerald-500/5"
                      )}
                    >
      ...
      >
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-20">
            ...
            <p className="text-zinc-400 text-lg max-w-2xl mx-auto">
              من الإثارة الأولى وحتى آخر توقيع وعقد، كل التفاعلات في منصة واحدة.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 rounded-[2rem] border border-white/5 bg-zinc-900/40 relative overflow-hidden group hover:border-white/10 transition-colors">
              ...
              <p className="text-zinc-400 text-sm font-medium leading-relaxed">
                سواء كنت تعمل في المقاولات أو الخدمات أو التجزئة، يمكنك تهيئة وتخصيص مسار المبيعات
                والصفقات ليتطابق تماماً مع طبيعة دورة مبيعات شركتك وتحديد المسؤوليات لكل فرد في
                فريقك.
              </p>
            </div>
            ...
            <div className="p-8 rounded-[2rem] border border-white/5 bg-zinc-900/40 relative overflow-hidden group hover:border-white/10 transition-colors">
              ...
              <p className="text-zinc-400 text-sm font-medium leading-relaxed">
                أول خط زمني حقيقي متكامل يجمع كل الاتصالات والملاحظات والعروض والمستندات والفواتير
                الصادرة والمدفوعة لنفس العميل في شاشة واحدة لسرعة الوصول والفهم الكامل لرحلة العميل.
              </p>
            </div>
            ...
            <div className="p-8 rounded-[2rem] border border-white/5 bg-zinc-900/40 relative overflow-hidden group hover:border-white/10 transition-colors">
              ...
              <p className="text-zinc-400 text-sm font-medium leading-relaxed">
                توقع حجم المبيعات والإيرادات المتوقع تحصيلها خلال الأشهر القادمة بناءً على نسب إغلاق
                صفقاتك السابقة ونسب نجاح المراحل المختلفة لسرعة اتخاذ القرار المالي.
              </p>
            </div>
          </div>
        </div>
      ...
      >
        <div className="container mx-auto px-6 max-w-5xl text-center relative z-10">
          ...
          <p className="text-zinc-400 text-lg md:text-xl font-medium max-w-2xl mx-auto mb-10 leading-relaxed">
            انضم إلى مئات الشركات السعودية والخليجية التي تدير صفقاتها وعملائها بالكامل عبر نظام
            تشغيل مدارج OS.
          </p>
