      ...
      <nav className="fixed top-0 left-0 w-full z-50 px-6 py-4 transition-all duration-300 backdrop-blur-md bg-white/70 border-b border-zinc-200">
        <div className="container mx-auto max-w-7xl flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link
              to="/contact"
              className="text-sm font-bold text-zinc-500 hover:text-zinc-900 transition-colors hidden sm:block"
            >
              تواصل معنا
            </Link>
            <Link
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          >
            ...
            <p className="text-xl text-zinc-500 font-medium max-w-2xl mx-auto">
              نحن لا نقدم وعوداً تقنية معقدة. نحن نمنحك نظاماً يفهم كيف تدير صالونك، متجرك، أو مكتبك
              الاستشاري في السوق المحلي.
            </p>
          </motion.div>
          ...
          <div className="space-y-12">
            ...
            >
              ...
              <div>
                <h2 className="text-3xl font-black mb-4 flex items-center gap-3">
                  <span className="bg-emerald-100 text-emerald-600 px-3 py-1 rounded-lg text-sm">
                    متاجر النقل والتجزئة
                  </span>
                  متجرك التجاري
                </h2>
                <p className="text-lg text-zinc-600 font-medium leading-relaxed mb-6">
                  العميل يطلب عبر الواتساب؟ استخدم ربط نقاط البيع (POS) وإدارة الطلبات السريعة. حوّل
                  طلب الواتساب إلى فاتورة مبيعات مدفوعة في ثوانٍ، وتتبع مخزونك بدقة تامة.
                </p>
                ...
                <Link
                  to="/app"
                  className="inline-flex items-center gap-2 bg-zinc-900 text-white px-6 py-3 rounded-xl font-bold hover:bg-zinc-800 transition-colors"
                >
            ...
            >
              ...
              <div className="text-right">
                <h2 className="text-3xl font-black mb-4 flex items-center gap-3 flex-row-reverse justify-end">
                  ...
                  <span className="bg-amber-100 text-amber-600 px-3 py-1 rounded-lg text-sm mr-auto">
                    مقاولات وبناء
                  </span>
                </h2>
                <p className="text-lg text-zinc-600 font-medium leading-relaxed mb-6">
                  إدارة المقاولات تعني مستخلصات، دفعات مجدولة، وإدارة موردين وعمالة. تحكم بمدفوعات
                  المشاريع، وأصدر فواتير الدفعات (Milestones) بسهولة مع نظام يحمي أجور عمالك (WPS).
                </p>
                <ul className="space-y-2 font-bold text-zinc-500 mb-8">
            ...
            >
              ...
              <div>
                ...
                <p className="text-lg text-zinc-600 font-medium leading-relaxed mb-6">
                  رحلة العميل لديك تبدأ باجتماع وتمر بعرض سعر ثم الموافقة. أدر خط الأنابيب
                  (Pipeline) الخاص بمبيعاتك، وحوّل عروض الأسعار إلى فواتير (Retainer) متكررة بكل
                  سلاسة واحترافية.
                </p>
                <ul className="space-y-2 font-bold text-zinc-500 mb-8">
            ...
            >
              ...
              <div className="text-right">
                <h2 className="text-3xl font-black mb-4 flex items-center gap-3 flex-row-reverse justify-end">
                  ...
                  <span className="bg-rose-100 text-rose-600 px-3 py-1 rounded-lg text-sm mr-auto">
                    خدمات ميدانية
                  </span>
                </h2>
                <p className="text-lg text-zinc-600 font-medium leading-relaxed mb-6">
                  حجز موعد عبر الواتساب &rarr; توليد فاتورة &rarr; دفع برابط إلكتروني. من مراكز
                  صيانة السيارات إلى الصالونات، قدم خدمة سريعة بدون انتظار العميل عند نقطة المحاسبة.
                </p>
                <ul className="space-y-2 font-bold text-zinc-500 mb-8">
